...
namespace MyCRMServices
{
    ...
    public class MobileService : IMobileService
    {
        ...
        public System.ServiceModel.Channels.Message AttendanceReportForHRAPIDaily(string StartingDate)
        {
            ...
            try
            {
                ...
                returnResult += new SchdulerDayView().AttendanceReportForHRAPIDaily(StartingDate);
                returnResult += "</AttendanceReportForHRAPI>";
        ...
        public System.ServiceModel.Channels.Message AttendanceReportForHRAPI(string dt1, string emptype, string Date)
        {


            var returnResult = string.Empty;
            DataTable returnResult1 = new DataTable();
            try
            {
                returnResult += "<Data>";

                returnResult += "<AttendanceReport>";
                returnResult1 = new SchdulerDayView().AttendanceReportForHRAPI(dt1, emptype, Date);
                returnResult += "</AttendanceReport>";
            ...
            JSONString = JsonConvert.SerializeObject(returnResult1);

            //return JSONString;
            //   return WebOperationContext.Current.CreateJsonResponse(JSONString);
        ...
        public System.ServiceModel.Channels.Message LoadExtimatedWorkingDaysdaysInField(string empid, string date)
        {
            var returnResult = string.Empty;
            try
            {
                ...
                returnResult += new SchdulerDayView().GetChartCounts(empid, date);
                returnResult += "</AllCountCharts>";
