...
namespace MyCRMServices
{
     ...
     */
        ...
        public string GetChartCounts(string pEmployeeId, string datefrom,string dateto)
        {
            ...
            try
            {
                _nv.Clear();
                _nv.Add("@EmployeeId-int", pEmployeeId.ToString());
                _nv.Add("@Datefrom-datetime", datefrom.ToString());
        ...
        [WebMethod]
        public string GetChartCountsForYear(string pEmployeeId)
        {
            string DCRReports = "";
    ...
    */
       ...
       */
        ...
        */
        ...
        //------------------------------------------------ Remove Address2 ---------------------------------------------------------------//
         [WebMethod]
        public string InsertNewDoctor(string DoctorName, string Gender, string Address1, string City, string Country, string MobileNumber1, string PhoneNumber, string DesignationId, string SpecialityId, string QualificationId, string ClassId, string frequency, string EmployeeId, string Latitude, string Longitude)
        //string Address2
        {
            ...
            try
            {
             ...
             //   _nv.Add("@Address2-nvarchar(255)", Address2);
                ...
                _nv.Add("@MobileNumber2-varchar(255)", PhoneNumber);
        ...
        [WebMethod]
        public string InsertNewDoctorBricksAndDistributor(string DoctorName, string Gender, string Address1, string City, string Country, string MobileNumber1, string PhoneNumber, string DesignationId, string SpecialityId, string QualificationId, string ClassId, string frequency, string EmployeeId, string Latitude, string Longitude, string brickid, string brickcityid, string distributorid)
        {
   ...
   */
        ...
        [WebMethod]
        public string AttendanceReportForHRAPIDaily(string StartingDate)
        {
            var returnString = "";


            var AttendanceReportForHRAPI = _dl.GetData("sp_AttendanceReportForHRAPIDaily", new NameValueCollection { { "@StartingDate-date", StartingDate } });
