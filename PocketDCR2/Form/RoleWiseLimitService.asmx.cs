...
namespace PocketDCR2.Form
{
    ...
    public class RoleWiseLimitService : System.Web.Services.WebService
    {
        ...
        public string InsertRoleWiseLimit(string fk_role, string StartLimit, string EndLimit, string isActive)
        {
            string returnString = "";
            try
            {
                ...
                _nvCollection.Add("@fk_role-nvarchar(max)", fk_role);

                DataSet ds = GetData("sp_RoleWiseLimitSelect", _nvCollection);
                ...
                {
                    returnString = "Duplicate Role Name!";
                }
                else
                {
                    _nvCollection.Clear();
                    ...
                    _nvCollection.Add("@fk_role-nvarchar(max)", fk_role);
                    _nvCollection.Add("@LimitStart-nvarchar(max)", StartLimit);
                    _nvCollection.Add("@LimitEnd-nvarchar(max)", EndLimit);
                    _nvCollection.Add("@isActive-nvarchar(max)", isActive);


                    DataSet ds1 = GetData("sp_RoleWiseLimitInsert", _nvCollection);
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string GetRoleWiseLimit(string ID)
        {
            string returnString = "";
            ...
            try
            {
                ...
                _nvCollection.Add("@fk_role-nvarchar(max)", "");
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string UpdateRoleWiseLimit(string ID, string fk_role, string StartLimit, string EndLimit, string isActive)
        {
            string returnString = "";
            ...
            try
            {
                ...
                DataSet ds = GetData("sp_RoleWiseLimitSelect", _nvCollection);
                ds.Tables[0].TableName="Value Exists";
                ds.Tables[1].TableName = "Value Not Exists";
                ...
                if(returnString=="")
                {
                    ...
                    DataSet ds3 = GetData("sp_RoleWiseLimitUpdate", _nvCollection);
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string DeleteRoleWiseLimit(string ID)
        {
            string returnString = "";
            ...
            try
            {
                ...
                DataSet ds = GetData("sp_RoleWiseLimitDelete", _nvCollection);
                if (ds.Tables[0].Rows.Count != 0)
                {
                    returnString = ds.Tables[0].ToJsonString();
                }
