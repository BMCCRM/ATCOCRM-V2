<%@ Page Title="Leave Approval" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="LeaveApproval.aspx.cs" Inherits="PocketDCR2.Form.LeaveApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="LeaveApproval.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dialog1" title="Leave">
        <p style="font-weight: bold; font-size: 20px;">Comparison of previous & new Leave.</p>
        <table style="width: 100%;">
            <tr>
                <td class="auto-style1">Previous Leave :</td>
                <td>
                    <label id="padd"></label>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">New Leave :</td>
                <td>
                    <label id="nadd"></label>
                </td>
            </tr>
