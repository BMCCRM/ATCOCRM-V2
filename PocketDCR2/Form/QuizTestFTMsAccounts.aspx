<%@ Page Title="Manage FTM Accounts" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="QuizTestFTMsAccounts.aspx.cs" Inherits="PocketDCR2.Form.QuizTestFTMsAccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Set Region Modal -->
    <div id="SetFTMRegionsModal" class="modal fade" role="dialog" style="display: none;">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="background: #b73a3c; color: #fff;">
                    <h4 class="modal-title">Set Region</h4>
                </div>
                <div class="modal-body ">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="nationalDD" name="nationalDD" onchange="onChangeNationalDD();"></select>
                            </div>
                        </div>
                    </div>
                    <div class="row">                        
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="national">Region:</label>
                                <%--<select class="form-control" id="regionDD" name="regionDD" disabled="disabled"></select>--%>
                                <div id="regionDD" style="border: 1px solid gray; min-height: 50px; max-height: 200px; padding: 10px; overflow-y: auto;">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary btnSaveRegion" onclick="SaveRegion();">Save</button>
                        </div>
                    </div>
                    <br />
                    <h4>FTM Regions List</h4>
                    <div class="row">
                        <div class="col-md-12" id="FillFTMRegions">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="clearSetRegionModalFields();">Close</button>
                </div>
            </div>
    ...
    <div class="container">
        <div class="page_heading">
            <h1>Manage FTM Accounts</h1>
        </div>

        <div class="row" id="FTMsListGrid">
        </div>
    </div>
    ...
    <script type="text/javascript" src="QuizTestFTMsAccounts.js"></script>
