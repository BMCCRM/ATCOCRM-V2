...
function GetDataInGrid(date) {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "DoctorIncentiveMap.asmx/GetLocationApproval",
            contentType: "application/json; charset=utf-8",
            data: mydata,
            dataType: "json",
            success: function (res) {
                onSuccessGridFill(res)           
                },
...
function (isConfirm) {
    if (isConfirm) {
        ...
        $.ajax({
            type: "POST",
            url: "DoctorIncentiveMap.asmx/allPostApproval",
            data: mydata,
            contentType: "application/json; charset=utf-8",
