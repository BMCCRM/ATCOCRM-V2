<%@ Page Title="Doctors Qualification" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="DoctorQualification.aspx.cs" Inherits="PocketDCR2.Form.DoctorQualification1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DoctorQualificationJs.js" type="text/javascript"></script>
</asp:Content>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <div class="page_heading">
                    <h1>
                        <img alt="" src="../Images/Icon/1330777288_qualification-history.png" />
                        Doctors Qualification</h1>
                ...
                <div class="wrapper-inner">
                        ...
                        <div class="ghierarchy2">
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <obout:Column Width="20" DataField="QulificationId" HeaderText="QulificationId" SortExpression="QulificationId"
                                            Visible="false" />
                                        <obout:Column Width="200" DataField="QualificationName" HeaderText="Qualification"
                                            SortExpression="QualificationName" />
                                        <obout:Column Width="50" DataField="IsActive" HeaderText="Status" SortExpression="IsActive" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [QulificationId], [QualificationName], [IsActive] FROM [DoctorQulification] ORDER BY [QualificationName]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Doctor Qualification</h2>
                            </div>
