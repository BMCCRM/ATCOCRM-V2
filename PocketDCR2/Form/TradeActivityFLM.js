...
function GetTradeActivityFLM() {

    $.ajax({
        type: "POST",
        url: "TradeActivityFLM.asmx/GridTradeActivityFLM",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: onSuccessTradeActivityFLM,
        error: onError,
...
function onSuccessTradeActivityFLM(data, status) {

    $('#GridTradeActivityFLM').empty();
    $('#GridTradeActivityFLM').prepend($('<table id="datatables" class="display" style="width: 670px;"><thead><tr>' +
                                        '<th Class="ob_gC_Fc">Trade Activity FLM</th>' +
    ...
    $.each(jsonObj, function (i, option) {
        $('#datatables').append($("<tr style='text-align:center;'><td class='ob_ST'>" + option.TradeActivityFLM + "</td><td class='ob_text'>"
    ...
    $('#GridTradeActivityFLM').append($('</tbody></table>'));
...
function btnYesClicked() {
    ...
    $.ajax({
        type: "POST",
        url: "TradeActivityFLM.asmx/DeleteTradeActivityFLM",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function SaveData() {
    $('#hdnMode').val("AddMode");
    myData = "{'TradeActivityFLM':'" + $('#txtTradeActivityFLM').val() + "'}";

    $.ajax({
        type: "POST",
        url: "TradeActivityFLM.asmx/InsertTradeActivityFLM",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function oGrid_Edit(sender) {
    ...
    $.ajax({
        type: "POST",
        url: "TradeActivityFLM.asmx/EditTradeActivityFLM",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function onSuccessGetStretchedTarget(data, status) {
    if (data.d != "") {
        ...
        jsonObj = jsonParse(data.d);
        $("#txtTradeActivityFLM").val(jsonObj[0].TradeActivityFLM);
...
function UpdateData() {
    ...
    myData = "{'id':'" + id + "','TradeActivityFLM':'" + $('#txtTradeActivityFLM').val() + "' }";

    $.ajax({
        type: "POST",
        url: "TradeActivityFLM.asmx/UpdateTradeActivityFLM",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
