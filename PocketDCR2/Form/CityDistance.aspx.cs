...
{
    public partial class CityDistance : System.Web.UI.Page
    {
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            int FromCityid = int.Parse(e.Row.Cells[1].Text);
            int ToCityid = int.Parse(e.Row.Cells[2].Text);
            //string teamids = e.Row.Cells[1].Text.ToString();
            lb.Attributes.Add("onClick", "oGrid_Edit('" + id + "','" + FromCityid + "','" + ToCityid + "');return false;");
        }
        #endregion
    }
}