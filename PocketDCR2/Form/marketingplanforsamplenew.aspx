<%@ Page Title="Sample Setup" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="marketingplanforsamplenew.aspx.cs" Inherits="PocketDCR2.Form.marketingplanforsamplenew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="marketingplanforsamplenew.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="d-flex justify-content-start">
                <div class="p-1 autowidht">
                    <div id="col1Region" class="form-group">
                        ...
                        <asp:TextBox ID="txtDate" runat="server" ClientIDMode="Static" AutoPostBack="false" CssClass="inp-form txtbox" ReadOnly="true" />
                ...
                <div class="p-1 autowidht">
                    <div class="form-group">
                        <button id="btnSearch" type='button' class="btnnor ani">Search</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="inner-center">
        <div style="width: 25% !important; float: right">
            <table>
                <tr>
                    <td>Select SKU For Sheet</td>
                </tr>
                <tr>
                    <td>
                        <select id="ddlProductsSKu" multiple="multiple" style="height: 150px !important; width: 100%;" class="styledselect_form_1 txtbox">
                            <option disabled="disabled" selected="selected">No Products Available</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="button" value="Create Sheet" class="btnnor ani" onclick="downloadRefSheet();" />
