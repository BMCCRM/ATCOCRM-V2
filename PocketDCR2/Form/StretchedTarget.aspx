<%@ Page Title="Commitment Level-Sale" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="StretchedTarget.aspx.cs" Inherits="PocketDCR2.Form.StretchedTarget" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="StretchedTarget.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Commitment Level-Sale</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        <th valign="top">
                                          Commitment Level-Sale :
                                        </th>
                                        <td>
                                            <input id="txtStretchedTarget" name="txtStretchedTarget" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
