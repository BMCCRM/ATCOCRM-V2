<%@ Page Title="Gifts Setup" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="GiftItems.aspx.cs" Inherits="PocketDCR2.Form.GiftItems" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="GiftItemsJs.js" type="text/javascript"></script>
</asp:Content>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <div class="page_heading">
                    <h1>
                        <img alt="" src="../Images/Icon/1330777106_present.png" />
                        Gifts Setup</h1>
                ...
                <div class="wrapper-inner">
                        ...
                        <div class="ghierarchy2">
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <obout:Column Width="100" DataField="GiftId" HeaderText="GiftId" SortExpression="GiftId"
                                            Visible="false" />
                                        <obout:Column Width="100" DataField="GiftCode" HeaderText="Code" SortExpression="GiftCode" />
                                        <obout:Column Width="250" DataField="GiftName" HeaderText="Gift" SortExpression="GiftName" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [GiftId], [GiftCode], [GiftName], CASE WHEN [IsActive] = 1 THEN 'Active' ELSE 'Deactive' END AS IsActive FROM [GiftItems] ORDER BY [GiftCode], [GiftName]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Gift</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtCode" name="txtCode" maxlength="20" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
                                    <tr>
