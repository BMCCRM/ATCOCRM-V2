<%@ Page Title="Brick Setup" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="BrickManagement.aspx.cs" Inherits="PocketDCR2.Form.BrickManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="BrickManagementJs.js" type="text/javascript"></script>
</asp:Content>
                        ...
                        <div class="ghierarchy2">
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <obout:Column Width="150" DataField="LevelId" HeaderText="LevelId" SortExpression="LevelId"
                                            Visible="false" Wrap="True" />
                                        <obout:Column Width="150" DataField="LevelName" HeaderText="Brick" SortExpression="LevelName" Wrap="True" />
                                        <obout:Column Width="200" DataField="LevelDescription" HeaderText="Description" SortExpression="LevelDescription" Wrap="True" />
                                        <obout:Column Width="80" DataField="IsActive" HeaderText="Status" SortExpression="IsActive" Wrap="True" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [LevelId], [LevelName], [LevelDescription], CASE WHEN [IsActive] = 1 THEN 'Active' ELSE 'Deactive' END AS IsActive FROM	HierarchyLevel6 WHERE LevelId NOT IN (SELECT ChildLevelId FROM RelationLevel5) ORDER BY LevelName">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
