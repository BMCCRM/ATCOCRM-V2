...
function GetCustomerChannelFocus() {

    $.ajax({
        type: "POST",
        url: "CustomerChannelFocus.asmx/GridCustomerChannelFocus",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: onSuccessCustomerChannelFocus,
        error: onError,
...
function onSuccessCustomerChannelFocus(data, status) {

    $('#GridCustomerChannelFocus').empty();
    $('#GridCustomerChannelFocus').prepend($('<table id="datatables" class="display" style="width: 670px;"><thead><tr>' +
                                        '<th Class="ob_gC_Fc">Customer Channel Focus</th>' +
    ...
    $.each(jsonObj, function (i, option) {
        $('#datatables').append($("<tr style='text-align:center;'><td class='ob_ST'>" + option.CustomerChannelFocus + "</td><td class='ob_text'>"
    ...
    $('#GridCustomerChannelFocus').append($('</tbody></table>'));
...
function btnYesClicked() {
    ...
    $.ajax({
        type: "POST",
        url: "CustomerChannelFocus.asmx/DeleteCustomerChannelFocus",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function SaveData() {
    $('#hdnMode').val("AddMode");
    myData = "{'CustomerChannelFocus':'" + $('#txtCustomerChannelFocus').val() + "'}";

    $.ajax({
        type: "POST",
        url: "CustomerChannelFocus.asmx/InsertCustomerChannelFocus",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function oGrid_Edit(sender) {
    ...
    $.ajax({
        type: "POST",
        url: "CustomerChannelFocus.asmx/EditCustomerChannelFocus",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function onSuccessGetStretchedTarget(data, status) {
    if (data.d != "") {
        ...
        jsonObj = jsonParse(data.d);
        $("#txtCustomerChannelFocus").val(jsonObj[0].CustomerChannelFocus);
...
function UpdateData() {
    ...
    myData = "{'id':'" + id + "','CustomerChannelFocus':'" + $('#txtCustomerChannelFocus').val() + "' }";

    $.ajax({
        type: "POST",
        url: "CustomerChannelFocus.asmx/UpdateCustomerChannelFocus",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
