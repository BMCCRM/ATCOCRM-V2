<%@ Page Title="Location Approval" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="DoctorIncentiveMap.aspx.cs" Inherits="PocketDCR2.Form.DoctorIncentiveMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DoctorIncentiveMap.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content">
        <div class="page_heading" style="display:none">
