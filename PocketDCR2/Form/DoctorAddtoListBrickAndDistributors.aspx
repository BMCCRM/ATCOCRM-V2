...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DoctorAddtoListBrickAndDistributors.js" type="text/javascript"></script>
            ...
            <ContentTemplate>
                <div class="page_heading">
                    <h1>
                        ...
                        My Requested Doctor List Distributors</h1>
                    <div class="right">
                        <div class="btn" id="ApproveAll">
                            <a id="btnApproveAll" name="btnApproveAll" type="button" class="btnsaless" style="display: none;">Approve All</a>
                        </div>
                        <div class="btn" style="float: right;" id="showmylistybtn">
                            <input id="btnmylist" name="btnlastvisits" type="button" class="btnsaless" value="Show My Dr List" />
                        </div>
                        <div class="btn" id="showlistybtn">
                            <a id="btnlastvisits" name="btnlastvisits" type="button" href="#popup1" class="btnsaless">Show Master List</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="divClassIdAndFrequencyUpdate" class="jqmConfirmation">
                    <div class="jqmTitle">
                        More Details
                    </div>
                    <div class="divEdit">
                        <div class="divTableUpdate">
                            ...
                            <div class="divRow">
                                Class:
                                <select id="singleClassUpdate" name="singleClassUpdate" class="styledselect_form_1" style="width: 142px; margin-left: 30px;">
                                    <option value="-1" selected="selected">Select Class</option>
                                </select>
                            </div>
                            <div class="divRow">
                                Distributor:
                                <select id="DistributorUpdate" name="DistributorUpdate" class="styledselect_form_1" style="width: 142px; margin-left: 30px;">
                                    <option value="-1" selected="selected">Select Distributor</option>
                                </select>
                            </div>
                            <div class="divRow">
                                Brick:
                                <select id="singleBrickUpdate" name="singleBrickUpdate" class="styledselect_form_1" style="width: 142px; margin-left: 30px;">
                ...
                <%--<div class="ghierarchy bottom" id="divDocUploader">
                    <div class="inner-head">
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="margin: 0 60px;">
                                <input type="button" class="customdown" onclick="downloadEmployeesheet()" value="DOWNLOAD FILE" />
                            </td>
                            <td>
                ...
                <div class="outerBox" id="outerboxid">
                    ...
                    <div id="popup1" style="z-index: 999" class="overlay">
                        <div class="popup">
                            ...
                            <select id="ddlcity" name="ddlcity" class="styledselect_form_1" onchange="cityselectchange();">
                ...
                <div id="popupMyDrList" class="modal fade" style="opacity: 1" role="dialog" aria-labelledby="popupDrmasster" data-backdrop="static" title="Master Details">
                    <div class="modal-dialog  modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button id="btnclosemydrlist" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h1 class="modal-title">My Doctor List</h1>
                            </div>
                ...
                <%--<link href="../Styles/demo_table1.8.0.css" rel="stylesheet" />
                <link href="../Styles/demo_table.css" rel="stylesheet" />
                <script src="../Scripts/jquery_datatable1.8.0.js"></script>
                <script src="../Scripts/jquery_datatable1.8.0.min.js"></script>--%>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
