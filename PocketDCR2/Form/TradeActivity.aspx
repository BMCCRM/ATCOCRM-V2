<%@ Page Title="Trade Activity" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="TradeActivity.aspx.cs" Inherits="PocketDCR2.Form.TradeActivity" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="TradeActivity.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Trade Activity</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtTradeActivity" name="txtTradeActivity" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
