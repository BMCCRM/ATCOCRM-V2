<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="CityDistance.aspx.cs" Inherits="PocketDCR2.Form.CityDistance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="CityDistance.js" type="text/javascript"></script>
    <style type="text/css">
      .loading {
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ContentTemplate>
                    <div class="page_heading">
                        <h1>List of City Distance
                        </h1>
                        <asp:HiddenField ID="hdnMode" runat="server" ClientIDMode="Static" />
                        <asp:HiddenField ID="remarks" runat="server" ClientIDMode="Static" />
                    </div>
                  ...
                  <div class="container" style="height:100vh; padding-top: 100px;">
                     ...
                     <div class="row">
                        <div class="col-md-3" style="margin-top:20px;">
                           <p style="font-size:18px;">From City</p>
                        </div>
                        <div id="colSpeciality" class="col-md-3" style="margin-top:20px;">
                           <select id="ddlFromCity" class="form-control w-100">
                     ...
                     <div class="row">
                        <div class="col-md-3" style="margin-top:20px;">
                           <p style="font-size:18px;">To City</p>
                        </div>
                        <div id="colCity" class="col-md-3" style="margin-top:20px;">
                           <select id="ddlToCity" class="form-control w-100">
                              <option value="-1">Select City</option>
                           </select>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-3" style="margin-top:20px;">
                           <p style="font-size:18px;">Distance km</p>
                        </div>
                        <div id="Distancecity" class="col-md-3" style="margin-top:20px;">
                           <input class="form-control input-sm" id="txtDistanceKm" type="text">
                        </div>
                     </div>
                   <div class="row">
                        <div class="col-md-3" style="margin-top:20px;">
                        ...
                        <div id="status" class="col-md-3" style="margin-top:20px;">
                           <select id="ddlstatus" class="form-control w-100">
