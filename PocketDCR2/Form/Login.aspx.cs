...
namespace PocketDCR2.Form
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool device = Request.Browser.IsMobileDevice;
            //if (device)
            //{
        ...
        protected void Login1_LoggedIn(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["Email"] = _currentUser.Email; 

                if (_currentUser != null)
                {
                    Session["CurrentUserId"] = _currentUser.EmployeeId;

                    Session["MenuLitral"] = (new GenericUtilityClass()).createMenu(_currentUser.EmployeeId);
                ...
                if (getHierarchyLevel.Count != 0)
                {
                    ...
                    if (hierarchyLevel == "Level1" || hierarchyLevel == "Level2" || hierarchyLevel == "Level3")
                    {
                                ...
                                else
                                {
                                    ...
                                    switch (roleType)
                                    {
                                        ...
                                        case "rl6":
                                            ...
                                            break;
                                        case "vfc":
                                            Response.Redirect("../Form/VirtualFeedBack.aspx");
                                            break;
                                        case "ftm":
                                            Response.Redirect("../Reports/newReports.aspx");
                                            break;
        ...
        protected void Login1_LoggingIn(object sender, LoginCancelEventArgs e)
        {
            ...
            if (isvalidUser != null)
            {
                ...
                {
                    Session["SessionDatabaseLoginID"] = GenericUtilityClass.CreateLoginLog(isvalidUser.EmployeeId, GenericUtilityClass.GetIPAddress(Request));
