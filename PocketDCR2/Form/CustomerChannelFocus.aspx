<%@ Page Title="CustomerChannelFocus" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="CustomerChannelFocus.aspx.cs" Inherits="PocketDCR2.Form.CustomerChannelFocus1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="CustomerChannelFocus.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    <div style="float: left">
                        <div class="ghierarchy2">
                            ...
                            <div id="GridCustomerChannelFocus">
                                </div>
                               </div> 
                        <%--    <div class="inner-left">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Customer Channel Focus</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        <th valign="top">
                                           Customer or Channel Focus :
                                        </th>
                                        <td>
                                            <input id="txtCustomerChannelFocus" name="txtCustomerChannelFocus" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
