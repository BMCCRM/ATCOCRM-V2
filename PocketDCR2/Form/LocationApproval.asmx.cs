...
{
    /// <summary>
    /// Summary description for LocationApproval1
    /// </summary>
    ...
    public class LocationApproval1 : System.Web.Services.WebService
    {
        DAL dl = new DAL();
        ...
        public string GetLocationApproval(string Level1Id, string Level2Id, string Level3Id, string Level4Id, string Level5Id, string Level6Id, string TeamID, string Role, string monthofrequest, string Status)
        {
            ...
            try
            {
                ...
                var data = dl.GetData("sp_GetDetailLocationApproval", _nvCollection);
