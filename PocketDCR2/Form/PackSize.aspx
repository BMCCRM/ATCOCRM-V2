<%@ Page Title="Package Size" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="PackSize.aspx.cs" Inherits="PocketDCR2.Form.PackSize" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="PackSizeJs.js" type="text/javascript"></script>
</asp:Content>
                        ...
                        <div class="ghierarchy2">
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <obout:Column Width="100" DataField="PackSizeid" HeaderText="PackSizeid" SortExpression="PackSizeid"
                                            Visible="false" />
                                        <obout:Column Width="300" DataField="SizeName" HeaderText="Package Size" SortExpression="SizeName" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [PackSizeid], [SizeName], CASE WHEN [IsActive] = 1 THEN 'Active' ELSE 'Deactive' END AS IsActive FROM [PackSize] ORDER BY [SizeName]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
                            ...
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtPackSize" name="txtPackSize" type="text" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                        <td>
                                        </td>
