...
function GetTradeActivity() {
    ...
    $.ajax({
        type: "POST",
        url: "TradeActivity.asmx/GridTradeActivity",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: onSuccessTradeActivity,
        error: onError,
...
function onSuccessTradeActivity(data, status) {

    $('#GridTradeActivity').empty();
    $('#GridTradeActivity').prepend($('<table id="datatables" class="display" style="width: 670px;"><thead><tr>' +
                                        '<th Class="ob_gC_Fc">Trade Activity</th>' +
    ...
    $.each(jsonObj, function (i, option) {
        $('#datatables').append($("<tr style='text-align:center;'><td class='ob_ST'>" + option.TradeActivity + "</td><td class='ob_text'>"
    ...
    $('#GridTradeActivity').append($('</tbody></table>'));
...
function btnYesClicked() {
    ...
    $.ajax({
        type: "POST",
        url: "TradeActivity.asmx/DeleteTradeActivity",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function SaveData() {
    $('#hdnMode').val("AddMode");
    myData = "{'TradeActivity':'" + $('#txtTradeActivity').val() + "'}";

    $.ajax({
        type: "POST",
        url: "TradeActivity.asmx/InsertTradeActivity",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
...
function oGrid_Edit(sender) {
    ...
    $.ajax({
        type: "POST",
        url: "TradeActivity.asmx/EditTradeActivity",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function onSuccessGetStretchedTarget(data, status) {
    if (data.d != "") {
        ...
        jsonObj = jsonParse(data.d);
        $("#txtTradeActivity").val(jsonObj[0].TradeActivity);
...
function UpdateData() {
    ...
    myData = "{'id':'" + id + "','TradeActivity':'" + $('#txtTradeActivity').val() + "' }";

    $.ajax({
        type: "POST",
        url: "TradeActivity.asmx/UpdateTradeActivity",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccess,
