<%@ Page Title="SellingSkillsFocusAreaFLM" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="SellingSkillsFocusAreaFLM.aspx.cs" Inherits="PocketDCR2.Form.SellingSkillsFocusAreaFLM1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="SellingSkillsFocusAreaFLM.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    <div style="float: left">
                        <div class="ghierarchy2">
                            ...
                            <div id="GridSellingSkillsFocusAreaFLM">
                                </div>
                               </div> 
                        <%--    <div class="inner-left">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Selling Skills Focus Area</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        <th valign="top">
                                           Selling Skills Focus Area :
                                        </th>
                                        <td>
                                            <input id="txtSellingSkillsFocusAreaFLM" name="txtSellingSkillsFocusAreaFLM" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
