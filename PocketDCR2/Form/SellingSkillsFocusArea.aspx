<%@ Page Title="Engagement Strategy" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="SellingSkillsFocusArea.aspx.cs" Inherits="PocketDCR2.Form.SellingSkillsFocusArea" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="SellingSkillsFocusArea.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    <div style="float: left">
                        <div class="ghierarchy2">
                            ...
                            <div id="GridSellingSkillsFocusArea">
                                </div>
                               </div> 
                        <%--    <div class="inner-left">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Engagement Strategy</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtSellingSkillsFocusArea" name="txtSellingSkillsFocusArea" maxlength="100" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
