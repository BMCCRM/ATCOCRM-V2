<%@ Page Title="Doctors Class" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="DoctorClasses.aspx.cs" Inherits="PocketDCR2.Form.DoctorClasses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DoctorClassesJs.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Class</h2>
                            </div>
                            <div class="designation-inner">
                                <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtFrequency" name="txtFrequency" maxlength="2" class="inp-form" />
                                            <span class="red">* </span>
                                        </td>
                                    </tr>
                                </table>
