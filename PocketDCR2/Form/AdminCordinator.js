...
var designation = '';
var designation2 = '';
var GlobalFlagForAutoFill = '';
var GlobalFlagVacantNew = "";
// Private Functions
...
function LoadForEditData() {
    ...
    if (CurrentUserRole == 'admin' || CurrentUserRole == 'admincoordinator') {
        ...
        if (CurrentUserRole == EditableDataRole) {

            HideHierarchy();
            $('#rowRole').hide();
        }
        else if (CurrentUserRole == 'admin' && EditableDataRole == 'headoffice' || CurrentUserRole == 'admincoordinator') {
...
function SaveData() {
    ...
    if (glbVarLevelName == "Level3" || glbVarLevelName == "Level2" || glbVarLevelName == "Level1") {
        if (level1Value == -1) {
            ...
            if (roleId == -1) {
                ...
                myData = "{'firstName':'" + $('#txtFirstName').val() + "','lastName':'" + $('#txtLastName').val()
                            ...
                            + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val()
                            ...
                            + "','type':'" + 0 + "','roleId':'" + roleId + "','depot':'" + "" + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            }
        }
            ...
            if (glbVarLevelName == "Level1") {
                myData = "{'firstName':'" + $('#txtFirstName').val() + "','lastName':'" + $('#txtLastName').val()
                 + "','middleName':'" + MiddleName + "','loginId':'" + $('#txtLoginId').val() + "','appointmentDate':'" + $('#txtAppointmentDate').val()
                 + "','gender':'" + $('#ddlGender').val() + "','designation':'" + $('#ddlDesignation').val() + "','employeeType':'" + 0
                 + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val() + "','city':'" + $('#ddlCity').val() + "','RelatedCityIDs':'" + $('select#ddlRelatedCity').val()
                 ...
                 + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + 0 + "','levelName': '" + glbVarLevelName + "','type':'Level1','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                             + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                             + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                             + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            }
            if (glbVarLevelName == "Level2") {
                ...
                + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + 0 + "','levelName': '" + glbVarLevelName + "','type':'Level2','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            ...
            if (glbVarLevelName == "Level3") {
               ...
               + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + 0 + "','levelName': '" + glbVarLevelName + "','type':'Level3','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                           + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                           + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                           + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            ...
            if (glbVarLevelName == "Level1") {
               ...
               + "','type':'Level2','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                           + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                           + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                           + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            ...
            if (glbVarLevelName == "Level2") {
             ...
             + "','type':'Level3','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                         + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                         + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                         + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
        ...
        + "','type':'Level4','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                    + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                    + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                    + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
            ...
            if (glbVarLevelName == "Level3") {
                ...
                myData = "{'firstName':'" + $('#txtFirstName').val() + "','lastName':'" + $('#txtLastName').val()
                      ...
                      + "','type':'Level5','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                                  + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                                  + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                                  + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value != -1 && level4Value != -1 && level5Value == -1 && employee1Id != -1 && employee2Id != -1 && employee3Id != -1 && employee4Id == -1) {
            ...
            if (glbVarLevelName == "Level3" && employeeType != -1) {
                myData = "{'firstName':'" + $('#txtFirstName').val() + "','lastName':'" + $('#txtLastName').val()
                 ...
                 + "','type':'Level6','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                             + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                             + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                             + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + 0 + "'}";
          ...
          + "','type':'Level6','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
                      + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                      + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                      + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "','TeamID':'" + $('#ddlTeam').val() + "'}";
...
//                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
//                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
//                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
//            }
//        }
//        else if (level1Value != -1 && level2Value == -1 && employee1Id == -1) {
...
//            }
//                //            else if (depor == -1) {
//                //                msg = 'Employee Depot Must Be Selected!';
//                //                $('#hlabmsg').append(msg);
//                //                $('#Divmessage').jqmShow();
//                //                return false;
//                //            }
...
//                        + "','email':'" + Email + "','currentAddress':'" + Address2 + "','permenantAddress':'" + Address1
//                        + "','remarks':'" + Remarks + "','level1':'" + 0 + "','level2':'" + 0 + "','level3':'" + level1Value
//                        + "','level4':'" + level2Value + "','level5':'" + level3Value + "','level6':'" + level4Value + "','managerId':'" + employee3Id
//                        + "','levelName': '" + glbVarLevelName + "','type':'Level6','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid
//                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
//                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
//                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
//            }
...
//        $.ajax({
//            type: "POST",
//            url: "AdminCordinatorService.asmx/InsertEmployee",
//            data: myData,
//            contentType: "application/json; charset=utf-8",
//            dataType: "json",
//            success: onSuccess,
...
function UpdateData() {
    ...
    if (glbVarLevelName == "Level1") {
        ...
        if (level1Value == -1) {
            ...
            if (roleId == -1) {
                ...
                myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val()
                    ...
                    + "','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
            }
                ...
                myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val()
                    + "','lastName':'" + $('#txtLastName').val() + "','middleName':'" + MiddleName + "','loginId':'" + $('#txtLoginId').val()
                    + "','appointmentDate':'" + 0 + "','resignationDate':'" + $('#txtResignationDate').val() + "','gender':'" + gender + "','designation':'" + $('#ddlDesignation').val() + "','employeeType':'" + 0
                    + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val() + "','city':'" + $('#ddlCity').val() + "','RelatedCityIDs':'" + $('select#ddlRelatedCity').val()
                    + "','mobileNumber':'" + $('#txtMobileNumber').val() + "','contactNumber1':'" + ContactNumber1 + "','contactNumber2':'" + ContactNumber2
                    + "','email':'" + Email + "','currentAddress':'" + Address2 + "','permenantAddress':'" + Address1
                    + "','remarks':'" + Remarks + "','level1':'" + 0 + "','level2':'" + 0 + "','level3':'" + 0 + "','level4':'" + 0 + "','level5':'" + 0
                    + "','level6':'" + 0 + "','managerId':'" + 0 + "','levelName': '" + glbVarLevelName + "','selectHierarchy': '" + 0 + "','type': '" + 0
                    + "','roleId':'" + roleId + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
            }
        }
        else if (level1Value != -1 && level2Value == -1 && (employee1Id == -1 || employee1Id == null)) {
            ...
            myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val()
                    ...
                    + "','employeeType':'" + 0 + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val()
                    + "','city':'" + $('#ddlCity').val() + "','RelatedCityIDs':'" + $('select#ddlRelatedCity').val() + "','mobileNumber':'" + $('#txtMobileNumber').val() + "','contactNumber1':'" + ContactNumber1
                    + "','contactNumber2':'" + ContactNumber2 + "','email':'" + Email + "','currentAddress':'" + Address2
                    + "','permenantAddress':'" + Address1 + "','remarks':'" + Remarks + "','level1':'" + level1Value + "','level2':'" + 0 + "','level3':'" + 0
                    + "','level4':'" + 0 + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + 0 + "','levelName': '" + glbVarLevelName
                    + "','selectHierarchy': '" + 1 + "','type': '" + 'Level3' + "','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
        }
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value == -1 && employee1Id != -1 && (employee2Id == -1 || employee2Id == null)) {
            myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val()
                    + "','lastName':'" + $('#txtLastName').val() + "','middleName':'" + MiddleName + "','loginId':'" + $('#txtLoginId').val()
                    + "','appointmentDate':'" + $('#txtAppointmentDate').val() + "','resignationDate':'" + $('#txtResignationDate').val() + "','gender':'" + gender + "','designation':'" + $('#ddlDesignation').val()
                    + "','employeeType':'" + 0 + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val()
                    ...
                    + "','level4':'" + 0 + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + employee1Id + "','levelName': '" + glbVarLevelName
                    + "','selectHierarchy': '" + 1 + "','type': '" + 'Level4' + "','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value != -1 && level4Value == -1 && employee1Id != -1 && employee2Id != -1 && (employee3Id == -1 || employee3Id == null)) {
            ...
            myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val()
                    ...
                    + "','level4':'" + 0 + "','level5':'" + 0 + "','level6':'" + 0 + "','managerId':'" + employee2Id + "','levelName': '" + glbVarLevelName
                    + "','selectHierarchy': '" + 1 + "','type': '" + 'Level5' + "','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
        }
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value != -1 && level4Value != -1 && level5Value == -1 && employee1Id != -1 && employee2Id != -1 && employee3Id != -1 && (employee4Id == -1 || employee4Id == null)) {
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value != -1 && level4Value != -1 && level5Value != -1 && level6Value == -1 && employee1Id != -1 && employee2Id != -1 && employee3Id != -1 && employee4Id != -1  && (employee5Id == -1 || employee5Id == null)) {
        ...
        else if (level1Value != -1 && level2Value != -1 && level3Value != -1 && level4Value != -1 && level5Value != -1 && level6Value != -1 && employee1Id != -1 && employee2Id != -1 && employee3Id != -1 && employee4Id != -1 && employee5Id != -1 && (employee6Id == -1 || employee6Id == null)) {
            ...
            if (employeeType == -1 || employeeType == 0) {
                ...
                myData = "{'employeeId':'" + EmployeeId + "','firstName':'" + $('#txtFirstName').val() + "','lastName':'" + $('#txtLastName').val()
                + "','middleName':'" + MiddleName + "','loginId':'" + $('#txtLoginId').val() + "','appointmentDate':'" + $('#txtAppointmentDate').val()
                + "','resignationDate':'" + $('#txtResignationDate').val() + "','gender':'" + gender + "','designation':'" + $('#ddlDesignation').val() + "','employeeType':'" + employeeType
                + "','isActive':'" + $('#chkActive').attr("checked") + "','country':'" + $('#cboCountries').val() + "','city':'" + $('#ddlCity').val()
                + "','RelatedCityIDs':'" + $('select#ddlRelatedCity').val() + "','mobileNumber':'" + $('#txtMobileNumber').val() + "','contactNumber1':'" + ContactNumber1 + "','contactNumber2':'" + ContactNumber2
                + "','email':'" + Email + "','currentAddress':'" + Address2 + "','permenantAddress':'" + Address1 + "','remarks':'" + Remarks
                + "','level1':'" + level1Value + "','level2':'" + level2Value + "','level3':'" + level3Value + "','level4':'" + level4Value + "','level5':'" + level5Value
                + "','level6':'" + level6Value + "','managerId':'" + employee5Id + "','levelName': '" + glbVarLevelName + "','selectHierarchy': '" + 1
                + "','type': '" + 'Level6' + "','roleId':'" + 0 + "','depot':'" + depor + "','isSample':'" + $('#IsSample').attr("checked") + "','GDBID':'" + gdbid + "','predays':'" + pree_d
                            + "','IsBikeAllowance':'" + $('#chkBikeAllowance').is(":checked")
                            + "','IsCarAllowance':'" + $('#chkCarAllowance').is(":checked")
                            + "','IsIBA':'" + $('#chkIBA').is(":checked") + "','employeeCode':'" + EmployeeCode + "'}";
        ...
        if (myData != "") {
            ...
            $.ajax({
                type: "POST",
                url: "AdminCordinatorService.asmx/UpdateEmployee",
                data: myData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: onSuccess,
        ...
        if (jsonObj != "") {
            ...
            try {
                ...
                if (dateResignation != "") {
                    ...
                    var getMonthresignation = standardResignationDate.getUTCMonth() + 1;
                    var getDayresignation = standardResignationDate.getUTCDate() + 1;
                    var getYearresignation = standardResignationDate.getUTCFullYear();
            ...
            if (GlobalFlagVacantNew != "AddMode" ) {
...
function onSuccessGetEmployeesMembership(data, status) {
    ...
    if (data.d != "") {
        ...
        if (GlobalFlagVacantNew != "AddMode" && mode == "EditMode") {
...
function onSuccess(data, status) {
    ...
    if (data.d == "OK") {
        ...
        else if (mode === "EditMode" && GlobalFlagVacantNew == "") {

            msg = 'Data updated succesfully!';
        }
        else if (mode === "EditMode"  && GlobalFlagVacantNew === "AddMode") {
...
function btnSaveClicked() {
    ...
    if (levelValue6 == -1 || levelValue6 == "" || levelValue6 == null) {
        //var stringLoginId = document.getElementById('txtLoginId').value;

        //if (!stringLoginId.match('^[a-zA-z]*$')) {

        //    alert('Only alphabets are allowed in loginId');
        //    return false;
        ...
        var digitLoginId = document.getElementById('txtLoginId').value;

        //if (!digitLoginId.match('^[0-9]*$')) {

        //    alert('Only digits allowed in loginId');
        //    return false;
        //}
        //else {
    ...
    if (pass > 0) {
        ...
        else if (GlobalFlagVacantNew == "AddMode" && mode == "EditMode")
        {
            SaveData();
        }
        else if (GlobalFlagVacantNew == "" && mode === "EditMode") {
...
// Obout Grid Events
function oGrid_Edit(sender, status) {
    GlobalFlagForAutoFill = status;
    $('#hdnMode').val("EditMode");
...
function onSuccessGetCityByEmpId(response) {
    ...
    if (response.d != '') {
        ...
        $("#ddlRelatedCity").val(arrayOfRelatedCities);
...
function addNewRecordOnHierarchy(HierarchyLevel1,HierarchyLevel2, HierarchyLevel3, HierarchyLevel4, HierarchyLevel5, HierarchyLevel6) {
    //alert("3 -" + HierarchyLevel3);
    //alert("4 -" + HierarchyLevel4);
    //alert("5 -" + HierarchyLevel5);
    //alert("6 -" + HierarchyLevel6);
    ClearFields();
    GlobalFlagVacantNew = "AddMode";
    if (glbVarLevelName == "Level1") {
        ...
        level1Id = (HierarchyLevel1 == "0") ? "-1" : HierarchyLevel1;
        level2Id = (HierarchyLevel2 == "0") ? "-1" : HierarchyLevel2;
        level3Id = (HierarchyLevel3 == "0") ? "-1" : HierarchyLevel3;
        level4Id = (HierarchyLevel4 == "0") ? "-1" : HierarchyLevel4;
        level5Id = (HierarchyLevel5 == "0") ? "-1" : HierarchyLevel5;
        level6Id = (HierarchyLevel6 == "0") ? "-1" : HierarchyLevel6;
    }



    GetEmployeeIDWithLevels(HierarchyLevel1, HierarchyLevel2,HierarchyLevel3, HierarchyLevel4, HierarchyLevel5, HierarchyLevel6);



}

function GetEmployeeIDWithLevels(Level1, Level2,Level3, Level4, Level5, Level6) {

    myData = "{'Level1':'" + Level1 + "','Level2':'" + Level2 + "','Level3':'" + Level3 + "','Level4':'" + Level4 + "','Level5':'" + Level5 + "','Level6':'" + Level6 + "'}";

    $.ajax({
        type: "POST",
        url: "AdminCordinatorService.asmx/GetEmployeeIDWithLevels",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: onSuccessGetEmployeeIDWithLevels,
        error: onError,
        beforeSend: startingAjax,
        complete: ajaxCompleted,
        cache: false,
...
function oGrid_DeActiveEmployee(DeActiveEmployeeID, DeActiveEmployeeCode, DeActiveEmployeeName) {


    $('#DeActiveEmployeeName').text("");
    $('#txtResignationDateDeactive').val("");
    $('#DeActiveEmployeeName').html(DeActiveEmployeeName);
    $('#overlay').fadeIn(300);

    globalDeActiveEmployee = DeActiveEmployeeID;



    $('#close,.CloseBTNPopup').click(function () {
        $('#overlay').fadeOut(300);
    });
}

function resignationDateAcceptedOfEmployee() {
    var ResigDate = $('#txtResignationDateDeactive').val();
    var timestamp = Date.parse(ResigDate);

    if (isNaN(timestamp) == true) {
        //var d = new Date(timestamp);
        alert("Please enter a vlid date");
    } else {
        if (globalDeActiveEmployee != 0) {

            myData = "{'employeeId':'" + globalDeActiveEmployee + "', 'ResigDate':'" + ResigDate + "'}";

            $.ajax({
                type: "POST",
                url: "AdminCordinatorService.asmx/ResignationDateAcceptedOfEmployeeById",
                data: myData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: onSuccessResignationDateAcceptedOfEmployeeById,
                error: onError,
                beforeSend: startingAjax,
                complete: ajaxCompleted,
                cache: false,
...
function onSuccessResignationDateAcceptedOfEmployeeById(data) {


    if (data.d == "successUpdate") {
        $('#overlay').fadeOut(300);

        //$("#btnRefresh").trigger('click');
        msg = 'Resignation Marked Successfully';

    } else {
        msg = 'Error in Marking Resignation '
    }
...
function onSuccessGetEmployeeIDWithLevels(response) {

    if (response.d != '') {
        var jsonObjNew = $.parseJSON(response.d);

        GlobalFlagForAutoFill = 1;
        $('#hdnMode').val("EditMode");
     
        EmployeeId = jsonObjNew[0].EmployeeId;
...
function DisableDDL(){
    ...
    $('#ddl11').attr('disabled', 'disabled');
    $('#ddl22').attr('disabled', 'disabled');
    $('#ddl33').attr('disabled', 'disabled');
    $('#ddl44').attr('disabled', 'disabled');
    $('#ddl55').attr('disabled', 'disabled');
    $('#ddlType').attr('disabled', 'disabled');
    $('#ddlRole').attr('disabled', 'disabled');
    $('#txtGDBID').attr('disabled', 'disabled');
...
function EnableDDL() {
    ...
    $('#ddl11').removeAttr('disabled');
    $('#ddl22').removeAttr('disabled');
    $('#ddl33').removeAttr('disabled');
    $('#ddl44').removeAttr('disabled');
    $('#ddl55').removeAttr('disabled');
