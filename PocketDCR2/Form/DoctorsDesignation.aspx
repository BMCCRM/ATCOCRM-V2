<%@ Page Title="Doctors Designation" Language="C#" MasterPageFile="~/MasterPages/Home.Master"
    AutoEventWireup="true" CodeBehind="DoctorsDesignation.aspx.cs" Inherits="PocketDCR2.Form.DoctorsDesignation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DoctorsDesignationJs.js" type="text/javascript"></script>
</asp:Content>
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <obout:Column Width="200" DataField="DesignationName" HeaderText="Designation" SortExpression="DesignationName">
                                            <HeaderStyle Font-Bold="True" />
                                        </obout:Column>
                                        <obout:Column Width="150" DataField="DesignationDescription" HeaderText="Description"
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [DesignationId], [DesignationName], [DesignationDescription] FROM	DoctorsDesignation ORDER BY DesignationName">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
