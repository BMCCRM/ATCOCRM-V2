<%@ Page Title="Sample Setup" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="marketingplanforsample.aspx.cs" Inherits="PocketDCR2.Form.marketingplanforsample" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="marketingssample.js"></script>
...
<div id="content">
     <div class="page_heading" style="padding-top:20px">
            <h1>
                Marketing Plan for Samples :&nbsp;&nbsp;&nbsp;
     ...
     <div class="divgrid">
               <table border="0" cellpadding="10" cellspacing="0" id="fdform">
                                ...
                                <tr class="slc">
                                    <th valign="top" id="g1" >
                                        <select id="dG1" name="dG1" class="styledselect_form_1 txtbox" style="height: 30px;">
                                            <option  value="-1">Select...</option>
                                        </select>
                                    </th>
                                    <th valign="top" id="g2">
                                        <select id="dG2" name="dG2" class="styledselect_form_1 txtbox" style="height: 30px">
                                            <option  value="-1">Select...</option>
                                        </select>
                                    </th>
                                    <th valign="top" id="g3">
                                        <select id="dG3" name="dG3" class="styledselect_form_1 txtbox" style="height: 30px">
                                            <option  value="-1">Select...</option>
                                        </select>
                                    </th>
                                    <th valign="top" id="g4">
                                        <select id="dG4" name="dG4" class="styledselect_form_1 txtbox" style="height: 30px">
                                            <option  value="-1">Select...</option>
                                        </select>
                                    </th>
                                </tr>
