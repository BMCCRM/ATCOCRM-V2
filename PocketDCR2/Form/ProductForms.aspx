<%@ Page Title="Form" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true"
    CodeBehind="ProductForms.aspx.cs" Inherits="PocketDCR2.Form.ProductForms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="ProductFormsJs.js" type="text/javascript"></script>
</asp:Content>
                ...
                <div class="wrapper-inner">
                        ...
                        <div class="ghierarchy2">
                            ...
                            <div class="inner-left">
                                <obout:Grid ID="Grid1" runat="server" Serialize="false" AutoGenerateColumns="false"
                                    ...
                                    AllowAddingRecords="false" FolderStyle="../Styles/GridCss" OnRowDataBound="Grid1_RowDataBound"
                                    AllowPageSizeSelection="false">
                                    <Columns>
                                        <obout:Column Width="100" DataField="FormId" HeaderText="FormId" SortExpression="FormId"
                                            Visible="false" />
                                        <obout:Column Width="300" DataField="FormName" HeaderText="Form" SortExpression="FormName" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PocketDCRConnectionString %>"
                                    SelectCommand="SELECT [FormId], [FormName] FROM [Forms] ORDER BY [FormName]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="clear">
                    ...
                    <div class="wrapper-inner-right">
                        <div class="designation">
                            <div class="inner-head">
                                <h2>
                                    <span class="spacer">&nbsp;</span>Add New Form</h2>
                            </div>
