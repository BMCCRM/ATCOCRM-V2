<%@ Page Title="BWSD" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="BWSD.aspx.cs" Inherits="PocketDCR2.BWSD.BWSD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="BWSD.js" type="text/javascript"></script>
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                           <%-- <tr>
                                                <table border="0" cellpadding="10" cellspacing="0" id="id-" style="font-weight: bold">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="txtDate" ClientIDMode="Static" runat="server"
                                                                CssClass="inp-form" />
                                                            
                                                       
                                                            <asp:CalendarExtender ID="cTextDate" Enabled="True" Format="MM/dd/yyyy" TargetControlID="txtDate" PopupButtonID="txtDate" runat="server">
                                                ...
                                                <td>
                                                     <div id="uploadifyDSR" style="position: relative;">
                                                        <div id="uploadify_button2" class="customdown">
                                                            <span class="uploadify-button-text" style="height: 50px;">UPLOAD FILE DSR</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
