<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="SaleReport_BrickAllocation.aspx.cs" Inherits="PocketDCR2.BWSD.SaleReport_BrickAllocation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%-- <link href="../assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../Scripts/json-minified.js" type="text/javascript"></script>
    <script src="../assets/global/toastr/toastr.min.js" type="text/javascript"></script>
    <script src="SaleReport_BrickAllocation.js"></script>
    <%--------------------------------------------------------------------------------------------------%>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 text-left">
                <button type="button" class="btn-lg mr-2 btncolor download-btn" id="Search">Search</button>
            </div>
