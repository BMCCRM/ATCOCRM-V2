...
function pageLoad() {
   ...
   // $('#ddlDistributors').change(GetAllDistributor);
    $('#btnSave').click(btnSaveClicked);
    $('#btnCancel').click(btnCancelClicked); 
    $('#Insert').click(btnInsertClicked);
    IsValidUser();
    //  FillDropDownListtop();
    ...
    $("#ddlDistributors").change(function () {
        ...
        var selectedDistributorId = $("#ddlDistributors").val();    //$(this).val();
        FillBricks(selectedDistributorId);
    });

    $("#ddlBricks").change(function () {
      
        var selectedddlBricksID = $("#ddlBricks").val();    //$(this).val();
...
function funDownloadExcel() {
    ...
    window.open("../Handler/DoctorAssign.ashx");
}
function GetDataInGrid() {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "../BWSD/BrickAllocationService.asmx/GetAllData",
...
/*--------------------------------------------------Distributor n Bricks------------------------------------------*/
function GetAllDistributor() {
    try {

        $.ajax({
            type: "POST",
            url: "../BWSD/BrickAllocationService.asmx/GetAllDistributor",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
           // success: FillddlDistributor,
            ...
            success: function (response, data, status) {
                ...
                if (response.d != 'No') {
                    ...
                    $.each(msg, function (i, option) {
                        $("#ddlDistributors").append("<option value='" + option.ID + "'>" + option.Distributor + "</option>");
                    });
                }
...
function FillBricks(id) {
    debugger;
    myData = "{'ID':'" + id + "'}";
    $.ajax({
        type: "POST",
        url: "../BWSD/BrickAllocationService.asmx/GetSalesBricKById_Dist",
        ...
        success: function (response, data, status) {
            $("#ddlBricks").empty();
            $("#ddlBricks").append("<option value='-1'>Select City</option>");
            if (response.d != 'No') {
                var msg = $.parseJSON(response.d);
                $.each(msg, function (i, option) {
                    $("#ddlBricks").append("<option value='" + option.ID + "'>" + option.BrickName + "</option>");
                });
            }
        },
        error: onError,
...
function InsertData() {
    ...
    var PercentageIn = $('#Percentage_Insert').val();
    var FK_ID = $("#ddlDistributors").val(); 
    var BrickID = $("#ddlBricks").val(); 
    var EmployeeID = $('#ddl6').val();
    ...
    else if (PercentageIn < 0) {
        alert('Percentage Should Not Be Less Than 0')
    }
    else if (PercentageIn == "") {
        alert('Percentage Should Not Be Null')
    }

    else if (EmployeeID == "") {
        alert('EmployeeID Should Not Be Null')
    }
    else if (BrickID == "") {
        alert('BrickID Should Not Be Null')
    }
    ...
    {
        myData = "{'FK_ID':'" + FK_ID + "','EmployeeID':'" + EmployeeID + "','BrickID':'" + BrickID + "','PercentageIn':'" + PercentageIn + "'}";
        $.ajax({
            type: "POST",
            url: "../BWSD/BrickAllocationService.asmx/InsertSalesData",
            data: myData,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function onSuccessInsert(data, status) {
    debugger
    if (data.d == "DataSuccessfullyInserted") {
        toastr.info('Data Insert succesfully!', 'Alert', {
            "closeButton": true,
            "debug": false,
    ...
    else if (data.d == "Brick Already Assign") {
        toastr.info('Brick Already Assign', 'Alert', {
            "closeButton": true,
            "debug": false,
            "positionClass": "toast-top-center",
            "onclick": null,
    ...
    else if (data.d == "Brick you trying to Assign is more than 100 per") {
        toastr.info('Brick you trying to Assign is more than 100 per', 'Alert', {
            "closeButton": true,
            "debug": false,
            "positionClass": "toast-top-center",
            "onclick": null,
...
function oGrid_Edit(sender) {
    ...
    $.ajax({
        type: "POST",
        url: "../BWSD/BrickAllocationService.asmx/GetSalesBricKById",
        data: myData,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function onSuccessGetdata(data, status) {
    debugger
    var IsActive = "";
    if (data.d != "") {
        ClearFields();
        var jsonObj = jsonParse(data.d);
        IsActive = jsonObj[0].IsActive;
        if (IsActive.toLowerCase() == "true") {
            $('#chkActive').prop("checked", true);
        } else {
            $('#chkActive').prop("checked", false);
        }
        $('#Percentage').val(jsonObj[0].SalesPercentage);
    }
}
...
function UpdateData() {
    ...
    if (Percentage > 100) {
        ...
        myData = "{'ID':'" + ID + "','isActive':'" + IsActive + "','Percentage':'" + Percentage + "'}";
        $.ajax({
            type: "POST",
            url: "../BWSD/BrickAllocationService.asmx/UpdateSalesData",
            data: myData,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: onSuccess,
...
function onSuccess(data, status) {
    ...
    else if (data.d == "Not Updated") {
        toastr.info('Can Not Update Data', 'Alert', {
            "closeButton": true,
            "debug": false,
            "positionClass": "toast-top-center",
            "onclick": null,
