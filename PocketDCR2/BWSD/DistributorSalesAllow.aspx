<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="DistributorSalesAllow.aspx.cs" Inherits="PocketDCR2.BWSD.DistributorSalesAllow" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="DistributorSalesAllow.js" type="text/javascript"></script>
    ...
    <div class="page-head">
        <div class="container-fluid">
            <div class="page-title">
                <h1><small>Distributor Sales Days Allows</small> </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-horizontal col-sm-6 ">
                                ...
                                <div class="form-group">
                                     ...
                                     <div id="isAllowDays" class="col-sm-6 ">
                                        <label id="LabelAllowDays" class="col-md-3 control-label">Is Allow Days :</label>
                                        <div class="col-md-9">
                                             
                                            <input id="txtAllowDays" class="form-control input-sm" />
                                        </div>
                                    </div>
