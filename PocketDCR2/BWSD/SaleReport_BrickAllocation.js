...
function pageLoad() {
    ...
    //Note If you want to find getdistributor on page load when sm logins then you will find it in last onsuccess(you need to go in multiple onsuccess) of GetCurrentUser()
    ...
    $('#Search').click(GetAllocatedBricks);
...
function fillDistributor() {
    ...
    if (CurrentUserRole != 'admin' && CurrentUserRole != 'admincoordinator' && CurrentUserRole != 'rl1' && CurrentUserRole != 'rl2' && CurrentUserRole != 'rl3' && CurrentUserRole != null && CurrentUserRole != "") {
        GetAllDistributor();
    }
...
function GetAllDistributorr(empid) {

    debugger;
    try {

        var myData = "{'employeeId':'" + empid + "'}";

        $.ajax({
            type: "POST",
            url: "../BWSD/BrickAllocationService.asmx/GetAllDistributorOnSM",
            data: myData,
            ...
            success: function (response, data, status) {
                ...
                if (response.d != 'No') {
                    ...
                    $.each(msg, function (i, option) {
                        $("#ddlDistributors").append("<option value='" + option.DistributorID + "'>" + option.DistributorName + "</option>");
                    });
                }
...
function GetAllocatedBricks() {

    debugger;

    var teamId = $('#dG7').val();
    var DistId = $('#ddlDistributors').val();

    if (CurrentUserRole == 'admin' || CurrentUserRole == 'admincoordinator') {

        if ($('#ddl1').val() == null || $('#ddl1').val() == '-1' && $('dG7').val() == null || $('dG7').val() == '-1') {
            ...
            for (var i = 1; i <= 6; i++) {
                if ($('#ddl' + i).val() !== null && $('#ddl' + i).val() !== '-1') {
                    count++;
                } else {
                    break; // Stop the loop if a null or '-1' value is encountered
                }
            }

            var empid = $('#ddl' + count).val();




            window.open("../Handler/AllocatedBricks.ashx?empid=" + empid + "&DistId=" + DistId + "&TeamId=" + teamId);
    ...
    if (CurrentUserRole == 'rl1')        //Director
    {


        if ($('#ddl1').val() == null || $('#ddl1').val() == '-1') {
    ...
    if (CurrentUserRole == 'rl4') {       //SM


        var teamId = $('#dG1').val();
        if ($('#dG1').val() == null || $('#dG1').val() == '-1') {
            ...
            if ($('#ddl2').val() !== null && $('#ddl2').val() !== '-1')
            {
                empid = $('#ddl2').val();
                empname = $('#ddl2 option:selected').text();

            }

            if ($('#ddlTeam').val() !== null && $('#ddlTeam').val() !== '-1')
            {
                empid = $('#ddlTeam').val();
                empname = $('#ddlTeam option:selected').text();
            ...
            window.open("../Handler/AllocatedBricks.ashx?empid=" + empid + "&DistId=" + DistId + "&TeamId=" + teamId + "&EmployeeName=" + empname);
    ...
    if (CurrentUserRole == 'rl5') {  //DSM
        if ($('#ddl1').val() == null || $('#ddl1').val() == '-1') {
            ...
            window.open("../Handler/AllocatedBricks.ashx?empid=" + empid + "&DistId=" + DistId + "&TeamId=-1");
...
function onSuccessGetLevels(data, status) {
    ...
    if (data.d != "") {
        ...
        if (glbVarLevelName == "Level1") {
            ...
            HierarchyLevel51 = "District";
            HierarchyLevel61 = "Territory";
    ...
    if (data.d != "") {
        ...
        if (glbVarLevelName == "Level1") {
            ...
            if (CurrentUserRole == 'rl3' || CurrentUserRole == 'headoffice') {
                ...
                $('#Label2').append(HierarchyLevel4 + " " + "");
                $('#Label3').append(HierarchyLevel5);
                $('#Label14').append(HierarchyLevel6);
            ...
            if (CurrentUserRole == 'rl4') {
                ...
                $('#Label5').append("Team");
                $('#Label6').append(HierarchyLevel51 + " " + "Level ");
                $('#Label13').append(HierarchyLevel61 + " " + "Level ");

            }
            if (CurrentUserRole == 'rl5') {
                name = 'Select ' + HierarchyLevel6;
                $('#Label1').append(HierarchyLevel6);
                $('#Label5').append(HierarchyLevel61 + " " + "Level ");
                $('#col77').hide();
                $('.Th12').hide();
            }
