...
function OnChangeddl6() {
   ...
   // if (levelValue != -1) {
        ...
        $.ajax({
            type: "POST",
            url: "NewSalesdashboard.asmx/GetTerritoryDoctors",
            data: myData,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function OnChangeddlDistributer() {
    ...
    myData = "{'DistributorIDs':'" + levelValue + "' }";
...
var GetSummarywiseReport = function () {
    $.ajax({
        type: "POST",
        url: "SaleReport.asmx/GetSummaryProductSale",
        contentType: "application/json; charset=utf-8",
...
function onSuccessGetSummaryReport(data, status) {
    ...
    if (data.d != ""  && data.d != "[]") {
        ...
        jsonObj = $.parseJSON(data.d);
        var tablestring = "<div class='portlet light portlet-fit'> " +
                            "  <div class='portlet-title'>" + "   <div class='caption'>" + "  <span class='caption-subject font-red sbold uppercase'>Product Wise Sale Report</span></div>" +
                            " </div>" +
                            "<div class='portlet-body'>  <div class='portlet-body flip-scroll'><div class='dataTables_wrapper'><table id='datatables' class='table table-bordered table-striped table-condensed flip-content'> <thead class='flip-content'>" +
                            "<tr >" +
                          "<th > Month-Year </th>" +
...
//var GetCustomerWiseDailywiseReport = function () {
//    debugger
//    $.ajax({
//        type: "POST",
//        url: "SaleReport.asmx/GetCustomerWiseDailySale",
//        contentType: "application/json; charset=utf-8",
//        data: "{'date':'" + $('#txtDate').val() + "','Level1':'" + $('#L1').val() + "','Level2':'" + $('#L2').val() + "','Level3':'" + $('#L3').val() + "','Level4':'" + $('#L4').val() + "','Level5':'" + $('#L5').val() + "','Level6':'" + $('#L6').val() + "','DistributorID':'" + $('#L7').val() + "','BrickID':'" + $('#ddlBricks').val() + "','ClientID':'" + $('#ddlcustomer').val() + "','EmployeeId':'0'}",
//        success: onSuccessGetCustomerWiseDailySaleReport,
//        error: onError,
//        cache: false,
//        asyn: false
//    });
...
//function onSuccessGetCustomerWiseDailySaleReport(data, status) {
//    var msg = [];
...
//            tablestring += "<td  >" + jsonObj[i].ClientName + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Product + " </td>";
//            tablestring += "<td  >" + jsonObj[i].ProductPrice + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d1 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV1 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d2 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV2 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d3 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV3 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d4 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV4 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d5 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV5 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d6 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV6 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d7 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV7 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d8 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV8 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d9 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV9 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d10 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV10 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d11 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV11 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d12 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV12 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d13 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV13 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d14 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV14 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d15 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV15 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d16 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV16 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d17 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV17 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d18 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV18 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d19 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV19 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d20 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV20 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d21 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV21 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d22 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV22 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d23 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV23 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d24 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV24 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d25 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV25 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d26 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV26 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d27 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV27 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d28 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV28 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d29 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV29 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d30 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV30 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].d31 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].DSV31 + " </td>";
//            tablestring += "<td  >" + jsonObj[i].MonthUnitQuantity + " </td>";
//            tablestring += "<td  >" + jsonObj[i].MonthlySaleValue + " </td>";
//            tablestring += "</tr>";
//        }
//        tablestring += "</tbody></table></div></div></div></div>";
...
var GetTeamProductWiseSaleReport = function () {
    ...
    if (distid != null || distid != '-1') {
        ...
        window.open("../BWSD/SalesReportHandler.ashx?date=" + date + "&DistId=" + distid + "&ProductId=" + ProductId + "&TeamId=" + TeamId + "&reportType=TeamProductSales", "Report");
...
function GetProducts(empid) {
   
    $.ajax({
        type: "POST",
        url: "../Form/Products.asmx/GetProductWithoutId",
        contentType: "application/json; charset=utf-8",
        data: "{'empid':'" + empid + "'}",
        success: onSuccessGetProducts,
        error: onError,
        cache: false
    });
}
function onSuccessGetProducts(data, status) {

    document.getElementById('ddlPro').innerHTML = "";

    if (data.d != "") {

        jsonObj = $.parseJSON(data.d);
        $('#ddlPro').append('<select data-placeholder="Select Product ..." class="chosen-select" style="width:100%" id="ddlT" multiple ></select>');
        value = '-1';
        name = 'Select Product';
        $("#ddlPro").append("<option value='" + value + "'>" + name + "</option>");

        $.each(jsonObj, function (i, tweet) {
            $("#ddlPro").append("<option value='" + tweet.ProductId + "'>" + tweet.ProductName + "</option>");
        });
    }
    else {
        $('#ddlPro').append('<select data-placeholder="No Products Are Available ..." class="chosen-select" style="width:100%" id="ddlbri" multiple ></select>');
...
//function onSuccessGetCustomerWiseUnits(data, status) {
//    var msg = [];
//    debugger;


    
//    var cdt = new Date($('#txtDate').val());
...
//        jsonObj = $.parseJSON(data.d);
//        var tablestring = "<div class='portlet light portlet-fit'> " +
//                            "  <div class='portlet-title'>" + "   <div class='caption'>" + "  <span class='caption-subject font-red sbold uppercase'>Customer Wise Sales Report</span></div>" +
//                            " </div>" +
//                            "<div class='portlet-body'>  <div class='portlet-body flip-scroll'><div class='dataTables_wrapper'><table id='datatables' class='table table-bordered table-striped table-condensed flip-content'> <thead class='flip-content'>" +
//                            "<tr >" +
//                            "<th > Team </th>" +
...
//                            "<th > Nov-" + year + " Unit </th>" +
//                            "<th > Dec-" + year + " unit </th>" +
//                            "<th > Jan-" + year1 + " Unit </th>" +
//                            "<th > Feb-" + year1 + " Unit </th>" +
//                             "<th >Mar-" + year1 + " Unit</th>" +
//                            "<th > Apr-" + year1 + " unit </th>" +
//                            "<th > May-" + year1 + " Unit  </th>" +
//                            "<th > Jun-" + year1 + " Unit  </th>" +
//                            "<th > Jul-" + year + " Value  </th>" +
//                            "<th > Aug-" + year + " Value </th>" +
//                            "<th > Sep-" + year + " Value </th>" +
//                             "<th >Oct-" + year + " Value</th>" +
//                            "<th > Nov-" + year + " Value </th>" +
//                            "<th > Dec-" + year + " Value  </th>" +
//                            "<th > Jan-" + year1 + " Value  </th>" +
//                            "<th > Feb-" + year1 + " Value </th>" +
//                             "<th >Mar-" + year1 + " Value</th>" +
//                            "<th > Apr-" + year1 + " Value </th>" +
//                            "<th > May-" + year1 + " Value  </th>" +
//                            "<th > Jun-" + year1 + " Value  </th>" +
//                            "</tr ></thead> <tbody>";

//        //style='background-color: #217ebd;color: white;' Division	Region	Zone	Territory	RegionName	SubRegionName	DistrictName	City	DistributorName	BrickName	Total	SalePercentage
//        for (var i = 0; i < jsonObj.length ; i++) {
//            tablestring += "<tr>";
//            tablestring += "<td  >" + jsonObj[i].Team + "</td>";
//            tablestring += "<td  >" + jsonObj[i].ClientId + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Customer + "</td>";
//            tablestring += "<td  >" + jsonObj[i].BrickID + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Brick + "</td>";     
//            tablestring += "<td  >" + jsonObj[i].Product + "</td>";
//            tablestring += "<td  >" + jsonObj[i].DistId + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Distributor + "</td>";  
//            tablestring += "<td  >" + jsonObj[i].JulUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Augunit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].SepUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].OctUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].NovUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Decunit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].JanUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].FebUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].MarUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].Aprunit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].MayUnit  + "</td>";
//            tablestring += "<td  >" + jsonObj[i].JunUnit + "</td>";
//            tablestring += "<td  >" + jsonObj[i].JulValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].AugValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].SepValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].OctValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].NovValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].DecValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].JanValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].FebValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].MarValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].AprValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].MayValue + "</td>";
//            tablestring += "<td  >" + jsonObj[i].JunValue + "</td>";
//            tablestring += "</tr>";
//        }
//        tablestring += "</tbody></table></div></div></div></div>";
//        $("#RenderReport").empty();
