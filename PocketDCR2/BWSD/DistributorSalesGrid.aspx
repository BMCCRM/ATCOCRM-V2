<%@ Page Title="Distributor Sales Grid" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="DistributorSalesGrid.aspx.cs" Inherits="PocketDCR2.BWSD.DistributorSalesGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="modal fade" id="myModal1" role="dialog" aria-labelledby="myModal1" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <!-- Modal footer -->
                <div class="modal-footer" id="divAddCustomer">
                  <button type="button" class="btn btn-primary">Update</button>
                </div>
 ...
 <!-- The Modal Product END -->
        ...
        <div class="row">
         ...
         <div class="row" id="col6Date">
            ...
            <div class="col-sm-0 col-md-2">
                <input id="txtDate" class="form-control input-sm w-40 d-inline-block" type="text" />
            </div>
            <div class="col-sm-0 col-md-2">
                 <button type="button" id="addButton" onclick="getList();" style="text-align: center; margin-left: 6px" class="btn btn-primary input-sm w-70 d-inline-block">Filter Month</button>
          
                  </div>
            <div class="col-sm-0 col-md-4" style="display:none;">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div id="CustomerGrid" class="table-responsive-sm"></div>
            </div>   
        </div>
   ...
   <%-- <script src="FileGridList.js" type="text/javascript"></script>--%>
    ...
    <script>
        ...
        function getList() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetFilesGridList",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function ViewTxtFile(Id, FileType, fileName) {
            ...
            if (FileType == "INVOICE") {
                $.ajax({
                    ...
                    url: "../SalesMod/FileGridList.asmx/GetInvoiceListValidation",
                    contentType: "application/json; charset=utf-8",
                    data: myData,
                    dataType: "json",
                ...
                $.ajax({
                    type: "POST",
                    url: "../SalesMod/FileGridList.asmx/GetCustomerListValidation",
                    contentType: "application/json; charset=utf-8",
                    data: myData,
                    dataType: "json",
                ...
                $.ajax({
                    type: "POST",
                    url: "../SalesMod/FileGridList.asmx/GetStockListValidation",
                    contentType: "application/json; charset=utf-8",
                    data: myData,
                    dataType: "json",
        ...
        function LoadingEditInvoiceData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetByIdInvoice",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function UpdateInvoiceData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/updateInvoiceData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function LoadingEditCustomerData(id) {
            ...
            $("#divAddCustomer").html("").append(" <button type='button' class='btn btn-primary create-task my-auto ml-auto updateCustomer' id='updateCustomer' onclick='UpdateCustomerData(" + id + ");'>Update</button>");

            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetByIdCustomer",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function UpdateCustomerData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/updateCustomerData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function LoadingEditStockData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetByIdStock",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function UpdateStockData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/updateStockData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function FillDistributor() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/ProductAlignmentService.asmx/GetAllDistributor",//sp_getalldistributor
                data: mydata,
                contentType: "application/json; charset=utf-8",
        ...
        function ReValidateeInvoice() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/RevalidateInvoiceData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function ReValidateeCustomer() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/RevalidateCustomerData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function ReValidateeStock() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/RevalidateStockData",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function getCustomer() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetTownList",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function getClient() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetClientList",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function getPrduct() {
            ...
            $.ajax({
                type: "POST",
                url: "../SalesMod/FileGridList.asmx/GetProductList",
                contentType: "application/json; charset=utf-8",
                data: myData,
                dataType: "json",
        ...
        function FinalInsertInvoicee() {
            ...
            if (Check == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../SalesMod/FileGridList.asmx/SendDbDataInInvoice",
                    contentType: "application/json; charset=utf-8",
                    data: myData,
                    dataType: "json",
        ...
        //            url: "../SalesMod/FileGridList.asmx/SendInvoiceData",
        //            contentType: "application/json; charset=utf-8",
        //            data: myData,
        //            dataType: "json",
        ...
        //        $.ajax({
        //            type: "POST",
        //            url: "../SalesMod/FileGridList.asmx/SendCustomerData",
        //            contentType: "application/json; charset=utf-8",
        //            data: myData,
        //            dataType: "json",
        ...
        //        $.ajax({
        //            type: "POST",
        //            url: "../SalesMod/FileGridList.asmx/SendStockData",
        //            contentType: "application/json; charset=utf-8",
        //            data: myData,
        //            dataType: "json",
