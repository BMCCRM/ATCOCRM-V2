...
{
    /// <summary>
    /// Summary description for NewDashboard1
    /// </summary>
    ...
    public class NewDashboard1 : System.Web.Services.WebService
    {
        ...
        {
            string status = GetRptStatus(date);
            ...
            var data = _dl.GetData((status == "Live" ? "sp_locationdata" : "sp_locationdata_archive"), _nvCollection).Tables[0];
        ...
        public string StartActualCallsWork(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId)
        {
            ...
            try
            {
                ...
                actualCalls = GetData((status == "Live" ? "crmdashboard_DActualCalls" : "crmdashboard_DActualCalls_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string StartDailyCallTrendWork(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            ...
            try
            {
                ...
                _nvCollection.Add("@CurrentUserRole-NVARCHAR", _currentUserRole.ToString());
                _nvCollection.Add("@Level1Id-int", Convert.ToString(Level1));
                _nvCollection.Add("@Level2Id-int", Convert.ToString(Level2));
                _nvCollection.Add("@Level3Id-int", Convert.ToString(Level3));
                _nvCollection.Add("@Level4Id-int", Convert.ToString(Level4));
                ...
                dailyCallTrend = GetData((status == "Live" ? "crmdashboard_DailyCallTrend_WithTeamwork_NewParameters" : "crmdashboard_DailyCallTrend_WithTeamwork_NewParameters_archive"), _nvCollection);
                ...
                foreach (string daay in labels)
                {
                    ...
                    else
                    {
                        ...
                        avgCall.Add(Math.Round((cor_sms / Convert.ToDouble(drCor["MIOs"])).ToString() == "NaN" ? 0 : (cor_sms / Convert.ToDouble(drCor["MIOs"])), 2));
                        kpi.Add(13.0);
                    }
                }
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string StartVisitFrequency(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            #region Object Intialization
            JavaScriptSerializer _jss = new JavaScriptSerializer();
            string result = string.Empty;
            ...
            try
            {
                ...
                visitFrequency = GetData((status == "Live" ? "crmdashboard_VisitFrequency_NewParameters" : "crmdashboard_VisitFrequency_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string PlannedVsActualCalls(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            ...
            try
            {
                ...
                plannedVSactualCalls = GetData((status == "Live" ? "crmdasboard_planedvsactual1_NewParameters" : "crmdasboard_planedvsactual1_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string GetAverageCalls(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            JavaScriptSerializer _jss = new JavaScriptSerializer();
            string result = string.Empty;
            var series = new Collection<DailyCallTrendSeri>();
            try
            {
                ...
                _nvCollection.Add("@endmonth-int", Convert.ToString(endmonth));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                avgCalls = GetData((status == "Live" ? "crmdashboard_DAvgCallse_NewParameters" : "crmdashboard_DAvgCallse_NewParameters_archive"), _nvCollection);
        ...
        public List<Top5MR> Top5Mr(string date, string endate, string Level1, string Level2, string Level3, string Level4,
                                    string Level5, string Level6, string EmployeeId, string TeamId)
        {
            //JavaScriptSerializer _jss = new JavaScriptSerializer();
            //string result = string.Empty;
            ...
            try
            {
                ...
                if (_currentUserRole != "rl6")
                {
                    ...
                    top5MR = GetData((status == "Live" ? "sp_DTop5MRe_NewParameters" : "sp_DTop5MRe_NewParameters_archive"), _nvCollection);
                    #endregion
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string TotalDoctorsPlannedVsActualCalls(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            var TotaoDocplannedVSactualCalls = new System.Data.DataSet();
            _nvCollection.Clear();
            TotaoDocplannedVSactualCalls.Clear();
            int year = 0, month = 0, endmonth = 0;
            var targetVsActual = new DataTable();
            ...
            try
            {
                ...
                _nvCollection.Add("@endmonth-int", Convert.ToString(endmonth));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                TotaoDocplannedVSactualCalls = GetData((status == "Live" ? "crmdasboard_TotalDocClassWise_ExecutionVSPlans_NewParameters" : "crmdasboard_TotalDocClassWise_ExecutionVSPlans_NewParameters_archive"), _nvCollection);
                ...
                var label = new ArrayList();
                var TotalDoc = new ArrayList();
                var planCall = new ArrayList();
                var actualCall = new ArrayList();

                foreach (DataRow item in TotaoDocplannedVSactualCalls.Tables[0].Rows)
                {
                    label.Add(item["Class"].ToString());
                    TotalDoc.Add(Convert.ToDouble(item["TotalDoctors"]));
                    planCall.Add(Convert.ToDouble(item["PlanVisits"]));
                    actualCall.Add(Convert.ToDouble(item["ActualVisits"]));
                }

                string[] Label = (string[])label.ToArray(typeof(string));
                double[] TotalDocClassWise = (double[])TotalDoc.ToArray(typeof(double));
                double[] PlanCall = (double[])planCall.ToArray(typeof(double));
                double[] ActualCall = (double[])actualCall.ToArray(typeof(double));
                ...
                series.Add(new DailyCallTrendSeri("No. Of Doctors", TotalDocClassWise));
                series.Add(new DailyCallTrendSeri("No. Of Planned Doctors", PlanCall));
                series.Add(new DailyCallTrendSeri("No. Of Calls Executed", ActualCall));
                result = _jss.Serialize(series);
        ...
        [WebMethod(EnableSession = true)]
        public List<Bottom5MR> Bottom5Mr(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            ...
            try
            {
                ...
                if (_currentUserRole != "rl6")
                {
                    ...
                    bottom5MR = GetData((status == "Live" ? "sp_Bottom5MRe_NewParameters" : "sp_Bottom5MRe_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string DailyRating(string EmployeeId, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string date, string TeamId)
        {
            int year = 0, month = 0;
            string status = GetRptStatus(date);
            if (date != "")
            ...
            var dailyRatingTrend = new System.Data.DataSet();
            dailyRatingTrend.Clear();
            _nvCollection.Clear();
            _nvCollection.Add("@Level1-bigint", Level1.ToString());
            _nvCollection.Add("@Level2-bigint", Level2.ToString());
            _nvCollection.Add("@Level3-bigint", Level3.ToString());
            _nvCollection.Add("@Level4-bigint", Level4.ToString());
            _nvCollection.Add("@Level5-bigint", Level5.ToString());
            _nvCollection.Add("@Level6-bigint", Level6.ToString());
            _nvCollection.Add("@EmployeeId-bigint", EmployeeId.ToString());
            _nvCollection.Add("@year-int", Convert.ToString(year));
            _nvCollection.Add("@month-int", Convert.ToString(month));
            _nvCollection.Add("@TeamID-int", TeamId.ToString());
            dailyRatingTrend = GetData((status == "Live" ? "sp_dailyRatingtrend_new" : "sp_dailyRatingtrend_new_archive"), _nvCollection);
            return dailyRatingTrend.Tables[0].ToJsonString();
        }
        [WebMethod(EnableSession = true)]
        public List<DailyCall> DailyCall(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            ...
            try
            {
                ...
                _nvCollection.Add("@Month-int", Convert.ToString(month));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                var dailyCallTrendwithteam = GetData((status == "Live" ? "crmdashboard_DailyCallTrend_NewParameters" : "crmdashboard_DailyCallTrend_NewParameters_archive"), _nvCollection);

                for (int i = 0; i < dailyCallTrendwithteam.Tables[0].Rows.Count; i++)
                {
                    t5.Add(new DailyCall(dailyCallTrendwithteam.Tables[0].Rows[i]["Days"].ToString(), dailyCallTrendwithteam.Tables[0].Rows[i]["CorrectSMS"].ToString(), dailyCallTrendwithteam.Tables[0].Rows[i]["MIOs"].ToString(), dailyCallTrendwithteam.Tables[0].Rows[i]["AVGC"].ToString()));
                }
        ...
        public List<Bottom5MR> Bottom5Mr1(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId)
        {
            ...
            try
            {
                ...
                if (_currentUserRole != "rl6")
                {
                    ...
                    bottom5MR = GetData((status == "Live" ? "PreSalesCalls_DataScreen_New" : "PreSalesCalls_DataScreen_New_archive"), _nvCollection);
        ...
        public string SmsCorrectness(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId)
        {
            ...
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@Month-int", Convert.ToString(month));
                dsCorrectSMS = GetData((status == "Live" ? "crmdashboard_CorrectSMS" : "crmdashboard_CorrectSMS_archive"), _nvCollection);
                dsInCorrectSMS = GetData((status == "Live" ? "crmdashboard_InCorrectSMS" : "crmdashboard_InCorrectSMS_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string AllChartsData(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                var series1 = new Collection<DailyCallTrendSeri>();
                ...
                _nvCollection.Add("@Month-int", Convert.ToString(month));
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@endmonth-int", Convert.ToString(month));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());

                classProdFreq = GetData("SP_GetAllDashboardChart", _nvCollection);

                if (classProdFreq != null)
                {
                    result = classProdFreq.Tables[0].ToJsonString() + "~";
                    result += classProdFreq.Tables[1].ToJsonString() + "~";
                    result += classProdFreq.Tables[2].ToJsonString() + "~";
                    result += classProdFreq.Tables[3].ToJsonString() + "~";
                    result += classProdFreq.Tables[4].ToJsonString() + "~";
                    result += TotalDocsPlannedVsActualCalls(classProdFreq.Tables[5]) + "~";
                    result += PlannedVsActual(classProdFreq.Tables[6]) + "~";
                    result += classProdFreq.Tables[7].ToJsonString() + "~";
                    result += classProdFreq.Tables[8].ToJsonString() + "~";
                    result += classProdFreq.Tables[9].ToJsonString() + "~";
                    result += DailyCallTred(classProdFreq.Tables[10], date) + "~";
                    result += classProdFreq.Tables[11].ToJsonString() + "~";
                    result += DailyCall_New(classProdFreq.Tables[12]) + "~";
                    result += VisitFrequency(classProdFreq.Tables[13]) + "~";
                    result += classProdFreq.Tables[14].ToJsonString() + "~";
                    result += classProdFreq.Tables[15].ToJsonString() + "~";
                    result += classProdFreq.Tables[16].ToJsonString() + "~";
                    result += classProdFreq.Tables[17].ToJsonString();
        ...
        public dynamic DailyCall_New(DataTable classProdFreq)
        {
            List<DailyCall> t5 = new List<DailyCall>();
            try
            {
                for (int i = 0; i < classProdFreq.Rows.Count; i++)
                {
                    t5.Add(new DailyCall(classProdFreq.Rows[i]["Days"].ToString(), classProdFreq.Rows[i]["CorrectSMS"].ToString(),
                        classProdFreq.Rows[i]["MIOs"].ToString(), classProdFreq.Rows[i]["AVGC"].ToString()));
                }
            }
            catch (Exception exception)
            {
            ...
            return _jss.Serialize(t5);
            //return t5;
        }


        public dynamic TotalDocsPlannedVsActualCalls(DataTable classProdFreq)
        {
            var series = new Collection<DailyCallTrendSeri>();
            var label = new ArrayList();
            var TotalDoc = new ArrayList();
            ...
            foreach (DataRow item in classProdFreq.Rows)
            {
                label.Add(item["Class"].ToString());
                TotalDoc.Add(Convert.ToDouble(item["TotalDoctors"]));
                planCall.Add(Convert.ToDouble(item["PlanVisits"]));
            ...
            series.Add(new DailyCallTrendSeri("No. Of Planned Doctors", PlanCall));
            series.Add(new DailyCallTrendSeri("No. Of Calls Executed", ActualCall));
            return _jss.Serialize(series);
        }


        public dynamic PlannedVsActual(DataTable classProdFreq)
        {
            var series = new Collection<DailyCallTrendSeri>();
            var label1 = new ArrayList();
            var planCall1 = new ArrayList();
            var actualCall1 = new ArrayList();

            foreach (DataRow item in classProdFreq.Rows)
            {
                label1.Add(item["Class"].ToString());
                planCall1.Add(Convert.ToDouble(item["PlanVisits"]));
                actualCall1.Add(Convert.ToDouble(item["ActualVisits"]));
            }

            string[] Label1 = (string[])label1.ToArray(typeof(string));
            double[] PlanCall1 = (double[])planCall1.ToArray(typeof(double));
            double[] ActualCall1 = (double[])actualCall1.ToArray(typeof(double));

            series.Add(new DailyCallTrendSeri("Target", PlanCall1));
            series.Add(new DailyCallTrendSeri("Actual", ActualCall1));
            return _jss.Serialize(series);
        }



        public dynamic VisitFrequency(DataTable classProdFreq)
        {
            DataTable dataTable = classProdFreq;
            var classA = new ArrayList();
            var classB = new ArrayList();
            var classC = new ArrayList();
            var series1 = new Collection<DailyCallTrendSeri>();
            ...
            series1.Add(new DailyCallTrendSeri("Class A+", classa));
            series1.Add(new DailyCallTrendSeri("Class A", classb));
            series1.Add(new DailyCallTrendSeri("Class B", classc));
            return _jss.Serialize(series1);
        }

        public dynamic DailyCallTred(DataTable classProdFreq, string date)
        {
            #region Object Intialization
            JavaScriptSerializer _jss = new JavaScriptSerializer();
            string result = string.Empty;
        ...
        [WebMethod(EnableSession = true)]
        public string estworkinddays(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                if (endate == date)
                {
                    ...
                    classProdFreq = GetData((status == "Live" ? "sp_est_workingANDdaysInField_NewParameters" : "sp_est_workingANDdaysInField_NewParameters_archive"), _nvCollection);
                }
                else
                {
                    _nvCollection.Add("@CurrentUserEmployeeId-INT", (_currentUser.EmployeeId).ToString());
                    ...
                    classProdFreq = GetData((status == "Live" ? "sp_est_workingANDdaysInFielde_NewParameters" : "sp_est_workingANDdaysInFielde_NewParameters_archive"), _nvCollection);
                }
        ...
        [WebMethod(EnableSession = true)]
        public string ProdFreClass(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@endmonth-int", Convert.ToString(endmonth));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                classProdFreq = GetData((status == "Live" ? "sp_class_prodfreqe_NewParameters" : "sp_class_prodfreqe_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string customercoveragebyclass(string date, string endate, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@endmonth-int", Convert.ToString(endmonth));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                customercoverage = GetData((status == "Live" ? "sp_customerCuverageByClasse_NewParameters" : "sp_customerCuverageByClasse_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string callsperday(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                customercoverage = GetData((status == "Live" ? "sp_Callsperdaye_NewParameters" : "sp_Callsperdaye_NewParameters_archive"), _nvCollection);
                #endregion
        ...
        [WebMethod(EnableSession = true)]
        public string GetSposCount(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                spocount = GetData((status == "Live" ? "sp_GetSposCount_NewParameters" : "sp_GetSposCount_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string BrandDetails(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                spocount = GetData((status == "Live" ? "sp_brandsDetailed_dashboard_NewParameters" : "sp_brandsDetailed_dashboard_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string SpecialistCoverd(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                spocount = GetData((status == "Live" ? "sp_specialistcovered_dashboard_NewParameters" : "sp_specialistcovered_dashboard_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string DocCountSpecialityWise(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                spocount = GetData((status == "Live" ? "sp_doccountspecialitywise_dashboard_NewParameters" : "sp_doccountspecialitywise_dashboard_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string DocCountClassWise(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@TeamID-int", TeamId.ToString());
                spocount = GetData((status == "Live" ? "sp_doccountclasswise_dashboard_NewParameters" : "sp_doccountclasswise_dashboard_NewParameters_archive"), _nvCollection);
        ...
        [WebMethod(EnableSession = true)]
        public string daysinfield(string date, string Level1, string endate, string Level2, string Level3, string Level4, string Level5, string Level6, string EmployeeId, string TeamId)
        {
            string result = string.Empty;
            try
            {
                ...
                if (month == endmonth)
                {
                    ...
                    _nvCollection.Add("@Year-int", Convert.ToString(year));
                    _nvCollection.Add("@TeamID-int", TeamId.ToString());
                    customercoverage = GetData((status == "Live" ? "sp_DaysInField_NewParameters" : "sp_DaysInField_NewParameters_archive"), _nvCollection);
                ...
                else
                {
                    ...
                    customercoverage = GetData("sp_DaysInFielde_NewParameters", _nvCollection);
        ...
        public string VisitBySpeciality(string date, string Level1, string Level2, string Level3, string Level4, string Level5, string Level6)
        {
            ...
            try
            {
                ...
                _nvCollection.Add("@Year-int", Convert.ToString(year));
                _nvCollection.Add("@Month-int", Convert.ToString(month));
                VisitBySpeciality = GetData((status == "Live" ? "crmdashboard_SpecialityNew" : "crmdashboard_SpecialityNew_archive"), _nvCollection);
    ...
    {
        public MyDataFormat(string X, int Y)
        {
            x = X;
            y = Y;
        }
    ...
    public class Top5MR
    {
        public Top5MR(string MR, string AVG, string JVC)
        {
            mr = MR;
            avg = AVG;
            jvc = JVC;
    ...
    [Serializable]
    public class Bottom5MR
    {
        public Bottom5MR(string MR, string AVG, string JVC)
        {
            mr = MR;
            avg = AVG;
            jvc = JVC;
    ...
    {
        public DailyCall(string DAYS, string CORRECTSMS, string MIOS, string AVGC)
        {
            days = DAYS;
            correctsms = CORRECTSMS;
            mios = MIOS;
    ...
    public class Levels
    {
        public Levels(string LevelNumber, int Value)
        {
