...
var CurrentFilterRange = FILTER_DAILY;
...
function FillLevel2() {
    ...
    if (value == '0') {
        ...
        var requestObject = {
            LevelType: 'Level2',
            LevelID: $.GetListsSelectedArrayString('#divSelectLevel1')
        }
...
function FillLevel3() {
    ...
    if (value == '0') {
        ...
        var requestObject = {
            LevelType: 'Level3',
            LevelID: $.GetListsSelectedArrayString('#divSelectLevel2')
        }
...
function FillLevel4() {
    ...
    if (value == '0') {
        ...
        var requestObject = {
            LevelType: 'Level4',
            LevelID: $.GetListsSelectedArrayString('#divSelectLevel3')
        }
...
function FillLevel5() {
    ...
    if (value == '0') {
        ...
        var requestObject = {
            LevelType: 'Level5',
            LevelID: $.GetListsSelectedArrayString('#divSelectLevel4')
        }
...
function FillLevel6() {
    ...
    var requestObject = {
        LevelType: 'Level6',
        LevelID: $.GetListsSelectedArrayString('#divSelectLevel5')
    }
...
function generateDataFilterObject() {
    ...
    var requestObject = {
        ...
        HierarchyLevel1: $.GetListsSelectedArrayString('#divSelectLevel1'),
        HierarchyLevel2: $.GetListsSelectedArrayString('#divSelectLevel2'),
        HierarchyLevel3: $.GetListsSelectedArrayString('#divSelectLevel3'),
        HierarchyLevel4: $.GetListsSelectedArrayString('#divSelectLevel4'),
        HierarchyLevel5: $.GetListsSelectedArrayString('#divSelectLevel5'),
        HierarchyLevel6: $.GetListsSelectedArrayString('#divSelectLevel6'),
        ...
        DistributorID: $.GetListsSelectedArrayString('#divSelectDistributor'),
        BrickID: $.GetListsSelectedArrayString('#divSelectBrick'),
        PharmacyID: $.GetListsSelectedArrayString('#divSelectPharmacy'),
...
function DashboardChartDistrictSalesByTeamAndProduct(rootObject) {
    ...
    var url = "Overview.asmx/DashboardChartDistrictSalesByTeamAndProduct";
    $.ajax({
        type: "POST",
        url: url,
        data: JSON.stringify(rootObject),
