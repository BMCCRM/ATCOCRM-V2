<%@ Page Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" Title="View Plan Status" CodeBehind="PlansStatusWindow.aspx.cs" Inherits="PocketDCR2.Reports.PlansStatusWindow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="PlansStatusWindow.js" type="text/javascript"></script>
                        ...
                        <div id="content-table-inner">
                            ...
                            <table border="0" cellpadding="10" cellspacing="0" id="fdform">
                                <tr>
                                    ...
                                    <th>
                                        <asp:Label ID="Label13" name="Label10" ClientIDMode="Static" runat="server"></asp:Label>
                                    </th>
                            ...
                            <table border="0" cellpadding="10" cellspacing="0" id="Table1">
                                 ...
                                 <tr>
                                    ...
                                    <th valign="top" id="Th55">Starting Date
                                     ...
                                     <th valign="top" id="label13">SM-DSM
                                    </th>
                                ...
                                <tr>
                                    <th valign="top" id="Th1">
                                        <select id="st" name="st" class="styledselect_form_1">
                                    ...
                                    <th valign="top" id="Th5">
                                        ...
                                        <asp:CalendarExtender ID="CalendarExtender1" TargetControlID="stdate" runat="server" Format="dd/MM/yyyy">
                                          ...
                                          <th valign="top" id="g7">
                                        <select id="dG7"   class="styledselect_form_1">
                                            <option value="0">Select Type</option>
                                            <option value="DSM">DSM</option>
                                            <option value="JDSM">JDSM</option>
