...
namespace PocketDCR2.Reports.CrystalReports.CallExecutionDetailsReport {
    using System;
    ...
    public class CallExecutionDetailsReport : ReportClass {
        
        public CallExecutionDetailsReport() {
        }
        
        public override string ResourceName {
            get {
                return "CallExecutionDetailsReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "PocketDCR2.Reports.CrystalReports.CallExecutionDetailsReport.CallExecutionDetails" +
                    "Report.rpt";
            }
            set {
                // Do nothing
    ...
    public class CachedCallExecutionDetailsReport : Component, ICachedReport {
        
        public CachedCallExecutionDetailsReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CallExecutionDetailsReport rpt = new CallExecutionDetailsReport();
            rpt.Site = this.Site;
            return rpt;
        }
