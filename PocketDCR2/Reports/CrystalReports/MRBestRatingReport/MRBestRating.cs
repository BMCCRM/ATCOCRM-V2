...
namespace PocketDCR2.Reports.CrystalReports.MRBestRatingReport {
    using System;
    ...
    public class MRBestRating : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PocketDCR2.Reports.CrystalReports.MRBestRatingReport.MRBestRating.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMRBestRating : Component, ICachedReport {
        
        public CachedMRBestRating() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MRBestRating rpt = new MRBestRating();
            rpt.Site = this.Site;
            return rpt;
        }
