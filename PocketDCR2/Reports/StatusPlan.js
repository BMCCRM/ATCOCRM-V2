...
function pageLoad() {
    ...
    $('#stdate').val(current_month + '/' + current_date + '/' + current_year);
    ...
    //$('#statusBtnSubmitted').clik(BtnSubmitted)
...
function onclick_btn1() {
    //console.log("Hellooo", $("#ddldistrib").val());
    var ddl6 = $("#ddl6").val();
    var devent = $("#devent").val();
    var stdate = $("#stdate").val();
    var txtdes = $("#txtdes").val();

    
    console.log($("#ddl6").val());
    console.log($("#devent").val());
    console.log($("#stdate").val());
    console.log($("#txtdes").val());

    
    myData = "{'EmployeeId':'" + ddl6 + "','AttTypeID':'" + devent + "','StartDateTime':'" + stdate + "' ,'Description':'" + txtdes + "'}";

        $.ajax({
            type: "POST",
            url: "PlanStatusWindow.asmx/AddMeetingByAdmin",
            data: myData,
