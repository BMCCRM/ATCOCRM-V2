...
function uploadFile() {
    ...
    var form = $('#fileForm')[0];
        ...
        $.ajax({
            ...
            type: "POST",
            url: '../Handler/NewGetExcel.ashx?date=' + $('#txtDate').val() + '&Type=U&Level5=' + $('#dG3').val(),
            data: formData,
            processData: false,
            contentType: false,
...
function OnChangetxtDate() {
    ...
    $('#uploadify_button').uploadify({
        ...
        'uploader': '../Handler/NewGetExcel.ashx?date=' + date + '&Type=U',
        'width': '140',
        'height': '25',
        'onUploadSuccess': function (file, data, response) {
            ...
            $.ajax({
                url: "../Handler/NewGetExcel.ashx?date=" + date + "&Type=" + 'PF' + '&FileName=' + file.name,
...
function CallHandler(monthlist, type,zoneid) {
    if (type = 'D') {
        window.open("../Handler/NewGetExcel.ashx?date=" + monthlist + "&Type=" + type + "&Level5=" + zoneid, "Calls");
    }
}
