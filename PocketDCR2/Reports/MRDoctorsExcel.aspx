<%@ Page Title="Doctor Upload" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true"
    CodeBehind="MRDoctorsExcel.aspx.cs" Inherits="PocketDCR2.Reports.MRDoctorsExcel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="MRDoctorsExcel.js" type="text/javascript"></script>
                            ...
                            <table border="0" cellpadding="10" cellspacing="0" id="Table1">
                                ...
                                <tr>
                                    ...
                                    <th valign="top" id="ThDownload">
                                        <input id="btnDownloadExcel" type="button" onclick="funDownloadExcel();" value="Download Excel of Doctors" />
                                    </th>
