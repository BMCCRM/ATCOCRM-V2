<%@ Page title="Pharmacy Brick Correction" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="BrickCorrection.aspx.cs" Inherits="PocketDCR2.SalesMod.BrickCorrection" %>
...
<%--    <script src="../assets/js/jquery3.1.0.js" type="text/javascript"></script>
    ...
    <link href="../assets/Select2/select2.min.css" rel="stylesheet" />
     <script src="BrickCorrection.js" type="text/javascript"></script>
            ...
            <div class="ghierarchy bottom" id="EmployeeDropDown" style="padding: 10px 10px 10px 10px;">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="width: 115px;"><b>Select Distributor : &nbsp;</b></td>

                        <td>
                            <select id="ddlDistributor" name="ddlDistributor" class="form-control" style="width:200px;">
                                <option value="-1">Select...</option>
                            </select>
                        </td>
                            <td style="width: 115px;"><b>Select Distributor : &nbsp;</b></td>
                          <td>
                            <select id="ddlBrick" name="ddlBrick" class="form-control" style="width: 180px;">
                                <option value="-1">Select...</option>
                            </select>
                        </td>
                        <td style="width: 80px;"><b>Approved/Not-Approved : &nbsp;</b></td>
                        
                            <td>
                               <input id="chkActive" name="chkActive" type="checkbox" value="Active" checked="checked" onchange="OnChangeIsApproved();" />
                                            
                            </td>
                           <td>
                               &nbsp;
                               <input id="btnGenerate" type="button" class="btnnor ani" value="Show Result" />
...
<%--            <div class="divgrid" id="griddiv">
             ...
             <div class="right">
              <div class="btn" style="float: right;display:none; " id="ApproveAll" >
                        <a id="btnApproveAll"  name="btnApproveAll" type="button" class="btn btn-info" onclick="ApproveAll()">Approve All</a>
                    </div>
                 </div>
                <div class="row">
