...
{
    /// <summary>
    /// Summary description for ZipSalesUploader
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    [System.Web.Script.Services.ScriptService]
    public class ZipSalesUploader : System.Web.Services.WebService
    {
        private DAL _dal;
        private DataSet _ds;
        ...
        private string GroupExtractedFilesByDist(FileInfo[] files)
        {
            ...
            foreach (var file in files)
            {
                ...
                {
                    FileLength = File.ReadLines(file.FullName).Count().ToString();
                }
